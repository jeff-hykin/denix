...
runtime.currentFile =
  "/Users/jeffhykin/repos/denix/tests/translation/eval_tasks_pure_setup/eval-okay-regex-match2.nix";

export default //
//
//
//
nixScope.builtins["map"](createFunc(/*arg:*/ "list", null, {}, (nixScope) => (
  /*let*/ createScope((nixScope) => {
    defGetter(
      nixScope,
      "re",
      (nixScope) => nixScope.builtins["head"](nixScope.list),
    );
    defGetter(
      nixScope,
      "str",
      (nixScope) => nixScope.builtins["elemAt"](nixScope.list)(1n),
    );
    return nixScope.builtins["match"](nixScope.re)(nixScope.str);
  })
)))([
  [`(.*)e?abi.*`, `linux`],
  [`(.*)e?abi.*`, `linux`],
  [`.*-none.*`, `x86_64-unknown-linux-gnu`],
  [`.*nvptx.*`, `x86_64-unknown-linux-gnu`],
  [`.*switch.*`, `x86_64-unknown-linux-gnu`],
  [`.*-uefi.*`, `x86_64-unknown-linux-gnu`],
  [`.*-none.*`, `x86_64-unknown-linux-gnu`],
  [`.*nvptx.*`, `x86_64-unknown-linux-gnu`],
  [`.*switch.*`, `x86_64-unknown-linux-gnu`],
  [`.*-uefi.*`, `x86_64-unknown-linux-gnu`],
  ...
  [`.*/.*`, `mktemp`],
  [`.*/.*`, `rm`],
  [`mirror://([a-z]+)/(.*)`, `mirror://gnu/m4/m4-1.4.19.tar.bz2`],
  [`5\\.[0-9]*[13579]\\..+`, `5.40.0`],
  [`mirror://([a-z]+)/(.*)`, `mirror://cpan/src/5.0/perl-5.40.0.tar.gz`],
  [`5\\.[0-9]*[13579]\\..+`, `5.40.0`],
  [`^([0-9][0-9\\.]*)(.*)$`, `addons`],
  [`^([0-9][0-9\\.]*)(.*)$`, `extras`],
  [`^([0-9][0-9\\.]*)(.*)$`, `10`],
  [`^([0-9][0-9\\.]*)(.*)$`, `11`],
  [`[[:space:]]*0*(-?[[:digit:]]+)[[:space:]]*`, `36`],
  [`0+`, `36`],
  [`/bin/([^/]+)`, `/bin/exec`],
  [`[[:alnum:],._+:@%/-]+`, `/bin/exec`],
  [`[[:alnum:],._+:@%/-]+`, `''`],
  [`[[:space:]]*(-?[[:digit:]]+)[[:space:]]*`, `26`],
  [`0[[:digit:]]+`, `26`],
  [`[[:space:]]*(-?[[:digit:]]+)[[:space:]]*`, `26`],
  [`0[[:digit:]]+`, `26`],
  [`[[:alnum:],._+:@%/-]+`, `@tcl@`],
  [`[[:alnum:],._+:@%/-]+`, `@[a-zA-Z_][0-9A-Za-z_'-]*@`],
  [
    `.*pypy.*`,
  ...
  [`(.*/)?\\.\\.(/.*)?`, `package.nix`],
  [`[[:alnum:]+_?=-][[:alnum:]+._?=-]*`, `coconutbattery-4.0.2,152`],
  ...
  [`^[[:digit:]].*`, `agave`],
  [`^(@([^/]+)/)?([^/]+)$`, `renderer`],
  [`[^[:space:]]*`, `900,906,908,1010,1012,1030`],
  [`[^[:space:]]*`, `''`],
  [`.*[0-9]_LIN(UX)?.sh`, `Wolfram_14.2.1_LIN.sh`],
  [`.*[0-9]_LIN(UX)?.sh`, `Wolfram_14.2.1_LIN_Bndl.sh`],
  [`.*[0-9]_LIN(UX)?.sh`, `Wolfram_14.2.0_LIN.sh`],
  [`.*[0-9]_LIN(UX)?.sh`, `Wolfram_14.2.0_LIN_Bndl.sh`],
  [`[A-Z]`, `b`],
  [`[A-Z]`, `l`],
  [`[A-Z]`, `E`],
  [`[A-Z]`, `T`],
  [`([0-9A-Za-z._])[0-9A-Za-z._-]*`, `pythoncheck.sh`],
  [`([0-9A-Za-z._])[0-9A-Za-z._-]*`, `pythoncheck.sh`],
  [`(.*)\\.git`, `systemtap.git`],
  [`[a-f0-9]*`, `release-5.2`],
  [`[a-f0-9]*`, `b7a857659f8485ee3c6769c27a3e74b0af910746`],
  [
    `.*pypy.*`,
    `/nix/store/iqlzcyc1z7nv804n9wc5k5i0l180wnbs-python3-3.12.10/bin/python3.12`,
  ],
  [`(.*)\\.git`, `gn`],
  [`[a-f0-9]*`, `df98b86690c83b81aedc909ded18857296406159`],
  [`.*-rc\\..*`, `22.14.0`],
  [
    `.*/linux-gecko-(.*).tar.bz2`,
  ...
  [`[[:alpha:]_][[:alnum:]_]*(\\.[[:alpha:]_][[:alnum:]_]*)*`, `local_cache`],
  [`^#(.*)$`, `20240715`],
  [`.*-rc\\..*`, `20.19.2`],
  [`(.+)+(.+)`, `21.0.7+6`],
  [
  ...
  [`.*llvm-tblgen.*`, `-DLLVM_ENABLE_RTTI:BOOL=TRUE`],
  [
    `.*llvm-tblgen.*`,
  ...
  [`.*[<>"'&].*`, `org.eclipse.jdt`],
  [`.*[<>"'&].*`, `20241203050026`],
  [`[a-zA-Z_][a-zA-Z0-9_'-]*`, `cpu`],
  [`[a-zA-Z_][a-zA-Z0-9_'-]*`, `bits`],
  [`armv[67]l-linux`, `x86_64-linux`],
  [`armv[67]l-linux`, `x86_64-linux`],
  [`0+`, `0`],
  [`[0-9]+`, `rc`],
  [
  ...
  [`^.*-unstable-([[:digit:]]{4})-([[:digit:]]{2})-([[:digit:]]{2})$`, `0.9.0`],
  [`(.+)/(.+)`, `rejeep/ansi.el`],
  [
  ...
  [`^[a-fA-F0-9]{40}$`, `3a667bdb3d7f0955a5a51c8468eac83210c1439e`],
  [
    `.*com/android/tools/build/gradle.*`,
    `https://repo.maven.apache.org/maven2/com/android/tools/build/gradle/maven-metadata.xml`,
  ],
  [`^[a-fA-F0-9]{40}$`, `dc0a228a5544988d4a920cfb40be9cd28db41423`],
  [`(.+)-b(.+)`, `8u442-b06`],
  [
  ...
  [`^\\.sw[a-z]$`, `package.nix`],
  [`^\\..*\\.sw[a-z]$`, `package.nix`],
  [`^\\.sw[a-z]$`, `pyproject.toml`],
  [`^\\..*\\.sw[a-z]$`, `pyproject.toml`],
  [`mpv[-_](.*)`, `mpv-notify-send`],
  [`mpv[-_](.*)`, `mpv-playlistmanager`],
  [
  ...
  [`/[0-9a-z]{52}`, `/run/opengl-driver`],
  [`/[0-9a-z]{52}`, `/dev/dri`],
  [`<(.*)>`, `_module`],
  [`<(.*)>`, `args`],
  [`<(.*)>`, `<name>`],
  [`<(.*)>`, `<name>`],
  [`[a-zA-Z_][a-zA-Z0-9_'-]*`, `2bwm`],
  [`[a-zA-Z_][a-zA-Z0-9_'-]*`, `pm.max_children`],
  [`(pypy|python)([[:digit:]]*)`, `override`],
  [`(pypy|python)([[:digit:]]*)`, `overrideDerivation`],
  [`(pypy|python)([[:digit:]]*)`, `pypy27`],
  [`(pypy|python)([[:digit:]]*)`, `pypy310`],
  [`^ref: (.*)$`, `ref: refs/heads/master`],
  [`^ref: (.*)$`, `f870c6ccc8951fc48aeb293cf3e98ade6ac42668`],
  [`^ref: (.*)$`, `ref: refs/heads/master`],
  [`^ref: (.*)$`, `f870c6ccc8951fc48aeb293cf3e98ade6ac42668`],
  [`.*\\.post[0-9]+`, `1.7.2`],
  [
  ...
  [`.*-large-wordlist.*`, `hunspell-dict-cs-cz-libreoffice-6.3.0.4`],
  [`.*-large-wordlist.*`, `hunspell-dict-da-dk-2.5.189`],
  [`.*-large-wordlist.*`, `hunspell-dict-en-au-large-wordlist-2018.04.16`],
  [`.*-large-wordlist.*`, `hunspell-dict-en-ca-large-wordlist-2018.04.16`],
  [
