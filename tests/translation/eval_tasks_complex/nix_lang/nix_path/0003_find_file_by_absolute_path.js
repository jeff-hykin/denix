...
// Auto-generated from tests/nix_tests/nix_lang_tests/tests/functional/nix_path.sh:15
...
const res = await runDenix(["--find-file", "by-absolute-path/simple.nix"], { env, cwd: SOURCE_ROOT })
const actual = (res.stdout || "").replace(/\n+$/, "")
const expected = `${SOURCE_ROOT}/simple.nix`
if (actual !== expected || res.code !== 0) {
    console.error("FAIL: --find-file by-absolute-path/simple.nix")
