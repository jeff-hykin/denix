...
// Auto-generated from tests/nix_tests/nixpkgs_lib_tests/lib/tests/network.sh:155
...
in
with lib; with lib.network; (mkEUI64Suffix "AB:CD:EF:G0:12:34"
)`,
    pattern: /is not a valid MAC address \(expected 6 octets of hex digits\)/,
    env: { NIX_PATH },
    label: "mkEUI64Suffix \"AB:CD:EF:G0:12:34\"",
})
