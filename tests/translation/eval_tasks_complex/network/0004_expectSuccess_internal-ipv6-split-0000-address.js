...
// Auto-generated from tests/nix_tests/nixpkgs_lib_tests/lib/tests/network.sh:84
...
in
with lib; with lib.network; ((internal._ipv6.split "::0000").address
)`,
    pattern: new RegExp('^' + "\\[0,0,0,0,0,0,0,0\\]" + '$'),
    env: { NIX_PATH },
    label: "(internal._ipv6.split \"::0000\").address",
})
