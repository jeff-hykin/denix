...
// Auto-generated from tests/nix_tests/nixpkgs_lib_tests/lib/tests/network.sh:109
...
in
with lib; with lib.network; ((internal._ipv6.split "::/0").prefixLength
)`,
    pattern: /IPv6 subnet should be in range \[1;128\], got 0/,
    env: { NIX_PATH },
    label: "(internal._ipv6.split \"::/0\").prefixLength",
})
