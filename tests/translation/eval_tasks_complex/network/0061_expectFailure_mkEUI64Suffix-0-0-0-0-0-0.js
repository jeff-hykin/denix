...
// Auto-generated from tests/nix_tests/nixpkgs_lib_tests/lib/tests/network.sh:151
...
in
with lib; with lib.network; (mkEUI64Suffix "0.0.0.0.0.0"
)`,
    pattern: /is not a valid MAC address \(expected 6 octets of hex digits\)/,
    env: { NIX_PATH },
    label: "mkEUI64Suffix \"0.0.0.0.0.0\"",
})
