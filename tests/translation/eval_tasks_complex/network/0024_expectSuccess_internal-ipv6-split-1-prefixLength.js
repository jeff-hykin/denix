...
// Auto-generated from tests/nix_tests/nixpkgs_lib_tests/lib/tests/network.sh:106
...
in
with lib; with lib.network; ((internal._ipv6.split "::/1").prefixLength
)`,
    pattern: new RegExp('^' + "1" + '$'),
    env: { NIX_PATH },
    label: "(internal._ipv6.split \"::/1\").prefixLength",
})
