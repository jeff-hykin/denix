...
// Auto-generated from tests/nix_tests/nixpkgs_lib_tests/lib/tests/network.sh:125
...
in
with lib; with lib.network; (mkEUI64Suffix "123456789ABC"
)`,
    pattern: new RegExp('^' + "\"1034:56ff:fe78:9abc\"" + '$'),
    env: { NIX_PATH },
    label: "mkEUI64Suffix \"123456789ABC\"",
})
