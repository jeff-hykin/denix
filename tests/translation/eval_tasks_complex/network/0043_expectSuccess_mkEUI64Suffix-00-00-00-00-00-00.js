...
// Auto-generated from tests/nix_tests/nixpkgs_lib_tests/lib/tests/network.sh:132
...
in
with lib; with lib.network; (mkEUI64Suffix "00.00.00.00.00.00"
)`,
    pattern: new RegExp('^' + "\"200:00ff:fe00:0000\"" + '$'),
    env: { NIX_PATH },
    label: "mkEUI64Suffix \"00.00.00.00.00.00\"",
})
