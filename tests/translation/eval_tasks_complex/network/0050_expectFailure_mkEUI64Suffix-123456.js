...
// Auto-generated from tests/nix_tests/nixpkgs_lib_tests/lib/tests/network.sh:140
...
in
with lib; with lib.network; (mkEUI64Suffix "123456"
)`,
    pattern: /is not a valid MAC address \(expected 6 octets of hex digits\)/,
    env: { NIX_PATH },
    label: "mkEUI64Suffix \"123456\"",
})
