...
*/ /*let*/ createScope((nixScope) => {
  Object.defineProperty(nixScope, "makeExtensible'", {
    enumerable: true,
    get() {
      return createFunc(/*arg:*/ "rattrs", null, {}, (nixScope) => (
        /*let*/ createScope((nixScope) => {
  ...
  Object.defineProperty(nixScope, "lib", {
    enumerable: true,
    get() {
      return nixScope["makeExtensible'"](
        createFunc(/*arg:*/ "self", null, {}, (nixScope) => (
          /*let*/ createScope((nixScope) => {
            Object.defineProperty(nixScope, "callLibs", {
              enumerable: true,
              get() {
            ...
            return createScope((nixScope) => {
              const obj = {};
              obj["trivial"] = nixScope.callLibs(
                new Path(["./trivial.nix"], []),
              );
              ...
              obj["strings"] = nixScope.callLibs(
                new Path(["./strings.nix"], []),
              );
              ...
              obj["modules"] = nixScope.callLibs(
                new Path(["./modules.nix"], []),
              );
              obj["options"] = nixScope.callLibs(
                new Path(["./options.nix"], []),
              );
              ...
              obj["asserts"] = nixScope.callLibs(
                new Path(["./asserts.nix"], []),
              );
              ...
              obj["sources"] = nixScope.callLibs(
                new Path(["./sources.nix"], []),
              );
              ...
              obj["setFunctionArgs"] =
                nixScope.self["trivial"]["setFunctionArgs"];
              ...
              obj["inPureEvalMode"] =
                nixScope.self["trivial"]["inPureEvalMode"];
              ...
              obj["genericClosure"] =
                nixScope.self["trivial"]["genericClosure"];
              ...
              obj["makeExtensible"] =
                nixScope.self["fixedPoints"]["makeExtensible"];
              ...
              obj["getAttrFromPath"] =
                nixScope.self["attrsets"]["getAttrFromPath"];
              ...
              obj["mapAttrs'"] = nixScope.self["attrsets"]["mapAttrs'"];
              obj["mapAttrsToList"] =
                nixScope.self["attrsets"]["mapAttrsToList"];
              obj["attrsToList"] = nixScope.self["attrsets"]["attrsToList"];
              obj["concatMapAttrs"] =
                nixScope.self["attrsets"]["concatMapAttrs"];
              ...
              obj["recursiveUpdate"] =
                nixScope.self["attrsets"]["recursiveUpdate"];
              obj["matchAttrs"] = nixScope.self["attrsets"]["matchAttrs"];
              obj["mergeAttrsList"] =
                nixScope.self["attrsets"]["mergeAttrsList"];
              obj["overrideExisting"] =
                nixScope.self["attrsets"]["overrideExisting"];
              obj["showAttrPath"] = nixScope.self["attrsets"]["showAttrPath"];
              obj["getOutput"] = nixScope.self["attrsets"]["getOutput"];
              obj["getFirstOutput"] =
                nixScope.self["attrsets"]["getFirstOutput"];
              ...
              obj["chooseDevOutputs"] =
                nixScope.self["attrsets"]["chooseDevOutputs"];
              obj["zipWithNames"] = nixScope.self["attrsets"]["zipWithNames"];
              obj["zip"] = nixScope.self["attrsets"]["zip"];
              obj["recurseIntoAttrs"] =
                nixScope.self["attrsets"]["recurseIntoAttrs"];
              obj["dontRecurseIntoAttrs"] =
                nixScope.self["attrsets"]["dontRecurseIntoAttrs"];
              obj["cartesianProduct"] =
                nixScope.self["attrsets"]["cartesianProduct"];
              ...
              obj["intersectAttrs"] =
                nixScope.self["attrsets"]["intersectAttrs"];
              ...
              obj["mutuallyExclusive"] =
                nixScope.self["lists"]["mutuallyExclusive"];
              ...
              obj["concatMapStrings"] =
                nixScope.self["strings"]["concatMapStrings"];
              ...
              obj["replaceStrings"] =
                nixScope.self["strings"]["replaceStrings"];
              obj["intersperse"] = nixScope.self["strings"]["intersperse"];
              obj["concatStringsSep"] =
                nixScope.self["strings"]["concatStringsSep"];
              ...
              obj["makeSearchPath"] =
                nixScope.self["strings"]["makeSearchPath"];
              obj["makeSearchPathOutput"] =
                nixScope.self["strings"]["makeSearchPathOutput"];
              obj["makeLibraryPath"] =
                nixScope.self["strings"]["makeLibraryPath"];
              obj["makeIncludePath"] =
                nixScope.self["strings"]["makeIncludePath"];
              obj["makeBinPath"] = nixScope.self["strings"]["makeBinPath"];
              obj["optionalString"] =
                nixScope.self["strings"]["optionalString"];
              ...
              obj["escapeShellArg"] =
                nixScope.self["strings"]["escapeShellArg"];
              obj["escapeShellArgs"] =
                nixScope.self["strings"]["escapeShellArgs"];
              obj["isStorePath"] = nixScope.self["strings"]["isStorePath"];
              obj["isStringLike"] = nixScope.self["strings"]["isStringLike"];
              obj["isValidPosixName"] =
                nixScope.self["strings"]["isValidPosixName"];
              ...
              obj["toSentenceCase"] =
                nixScope.self["strings"]["toSentenceCase"];
              obj["addContextFrom"] =
                nixScope.self["strings"]["addContextFrom"];
              ...
              obj["versionAtLeast"] =
                nixScope.self["strings"]["versionAtLeast"];
              ...
              obj["cmakeOptionType"] =
                nixScope.self["strings"]["cmakeOptionType"];
              ...
              obj["enableFeatureAs"] =
                nixScope.self["strings"]["enableFeatureAs"];
              obj["withFeature"] = nixScope.self["strings"]["withFeature"];
              obj["withFeatureAs"] = nixScope.self["strings"]["withFeatureAs"];
              obj["fixedWidthString"] =
                nixScope.self["strings"]["fixedWidthString"];
              obj["fixedWidthNumber"] =
                nixScope.self["strings"]["fixedWidthNumber"];
              ...
              obj["noDepEntry"] =
                nixScope.self["stringsWithDeps"]["noDepEntry"];
              obj["fullDepEntry"] =
                nixScope.self["stringsWithDeps"]["fullDepEntry"];
              obj["packEntry"] = nixScope.self["stringsWithDeps"]["packEntry"];
              obj["stringAfter"] =
                nixScope.self["stringsWithDeps"]["stringAfter"];
              ...
              obj["lazyDerivation"] =
                nixScope.self["derivations"]["lazyDerivation"];
              obj["optionalDrvAttr"] =
              ...
              obj["pathIsDirectory"] =
                nixScope.self["filesystem"]["pathIsDirectory"];
              ...
              obj["cleanSourceWith"] =
                nixScope.self["sources"]["cleanSourceWith"];
              obj["pathHasContext"] =
                nixScope.self["sources"]["pathHasContext"];
              obj["canCleanSource"] =
                nixScope.self["sources"]["canCleanSource"];
              ...
              obj["mergeModules'"] = nixScope.self["modules"]["mergeModules'"];
              obj["mergeOptionDecls"] =
                nixScope.self["modules"]["mergeOptionDecls"];
              obj["mergeDefinitions"] =
                nixScope.self["modules"]["mergeDefinitions"];
              ...
              obj["filterOverrides"] =
                nixScope.self["modules"]["filterOverrides"];
              obj["sortProperties"] =
                nixScope.self["modules"]["sortProperties"];
              obj["fixupOptionType"] =
                nixScope.self["modules"]["fixupOptionType"];
              ...
              obj["mkOptionDefault"] =
                nixScope.self["modules"]["mkOptionDefault"];
              ...
              obj["mkFixStrictness"] =
                nixScope.self["modules"]["mkFixStrictness"];
              ...
              obj["fixMergeModules"] =
                nixScope.self["modules"]["fixMergeModules"];
              ...
              obj["mkDerivedConfig"] =
                nixScope.self["modules"]["mkDerivedConfig"];
              ...
              obj["mkEnableOption"] =
                nixScope.self["options"]["mkEnableOption"];
              ...
              obj["mergeOneOption"] =
                nixScope.self["options"]["mergeOneOption"];
              obj["mergeEqualOption"] =
                nixScope.self["options"]["mergeEqualOption"];
              ...
              obj["optionAttrSetToDocList'"] =
                nixScope.self["options"]["optionAttrSetToDocList'"];
              obj["scrubOptionValue"] =
                nixScope.self["options"]["scrubOptionValue"];
              obj["literalExpression"] =
                nixScope.self["options"]["literalExpression"];
              obj["literalExample"] =
                nixScope.self["options"]["literalExample"];
              ...
              obj["mkPackageOption"] =
                nixScope.self["options"]["mkPackageOption"];
              ...
              obj["defaultTypeMerge"] =
                nixScope.self["types"]["defaultTypeMerge"];
              ...
              obj["maybeAttrNullable"] =
                nixScope.self["misc"]["maybeAttrNullable"];
              ...
              obj["lazyGenericClosure"] =
                nixScope.self["misc"]["lazyGenericClosure"];
              obj["innerModifySumArgs"] =
                nixScope.self["misc"]["innerModifySumArgs"];
              obj["modifySumArgs"] = nixScope.self["misc"]["modifySumArgs"];
              obj["innerClosePropagation"] =
                nixScope.self["misc"]["innerClosePropagation"];
              obj["closePropagation"] =
                nixScope.self["misc"]["closePropagation"];
              ...
              obj["mergeAttrsWithFunc"] =
                nixScope.self["misc"]["mergeAttrsWithFunc"];
