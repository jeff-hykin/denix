...
*/(function(){
    ...
    try {
        Object.defineProperty(nixScope, "makeExtensible'", {enumerable: true, get(){return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["rattrs"] = arg; runtime.scopeStack.push(nixScope); try { return (function(){
    const nixScope = {...runtime.scopeStack.slice(-1)[0]};
    runtime.scopeStack.push(nixScope);
    try {
        Object.defineProperty(nixScope, "self", {enumerable: true, get(){return operators.merge(nixScope["rattrs"](nixScope["self"]), ({"extend": (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["f"] = arg; runtime.scopeStack.push(nixScope); try { return nixScope["lib"]["makeExtensible"]((nixScope["lib"]["extends"](nixScope["f"])(nixScope["rattrs"]))); } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1])}));}});
        return nixScope["self"];
    } finally {
        runtime.scopeStack.pop();
    }
})(); } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1]);}});
        Object.defineProperty(nixScope, "lib", {enumerable: true, get(){return nixScope["makeExtensible'"](((function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["self"] = arg; runtime.scopeStack.push(nixScope); try { return (function(){
    const nixScope = {...runtime.scopeStack.slice(-1)[0]};
    runtime.scopeStack.push(nixScope);
    try {
        Object.defineProperty(nixScope, "callLibs", {enumerable: true, get(){return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["file"] = arg; runtime.scopeStack.push(nixScope); try { return nixScope["import"](nixScope["file"])(({"lib": nixScope["self"]})); } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1]);}});
        return (function(){
    const nixScope = {...runtime.scopeStack.slice(-1)[0]};
    runtime.scopeStack.push(nixScope);
    try {
    const obj = {};
        ...
        obj["fixedPoints"] = nixScope["callLibs"]((new Path(["./fixed-points.nix"], [])));
        obj["attrsets"] = nixScope["callLibs"]((new Path(["./attrsets.nix"], [])));
        obj["lists"] = nixScope["callLibs"]((new Path(["./lists.nix"], [])));
        obj["strings"] = nixScope["callLibs"]((new Path(["./strings.nix"], [])));
        obj["stringsWithDeps"] = nixScope["callLibs"]((new Path(["./strings-with-deps.nix"], [])));
        obj["customisation"] = nixScope["callLibs"]((new Path(["./customisation.nix"], [])));
        obj["derivations"] = nixScope["callLibs"]((new Path(["./derivations.nix"], [])));
        obj["maintainers"] = nixScope["import"]((new Path(["../maintainers/maintainer-list.nix"], [])));
        obj["teams"] = nixScope["callLibs"]((new Path(["../maintainers/team-list.nix"], [])));
        obj["meta"] = nixScope["callLibs"]((new Path(["./meta.nix"], [])));
        obj["versions"] = nixScope["callLibs"]((new Path(["./versions.nix"], [])));
        ...
        obj["licenses"] = nixScope["callLibs"]((new Path(["./licenses.nix"], [])));
        obj["sourceTypes"] = nixScope["callLibs"]((new Path(["./source-types.nix"], [])));
        obj["systems"] = nixScope["callLibs"]((new Path(["./systems"], [])));
        obj["cli"] = nixScope["callLibs"]((new Path(["./cli.nix"], [])));
        obj["gvariant"] = nixScope["callLibs"]((new Path(["./gvariant.nix"], [])));
        obj["generators"] = nixScope["callLibs"]((new Path(["./generators.nix"], [])));
        obj["asserts"] = nixScope["callLibs"]((new Path(["./asserts.nix"], [])));
        obj["debug"] = nixScope["callLibs"]((new Path(["./debug.nix"], [])));
        obj["misc"] = nixScope["callLibs"]((new Path(["./deprecated/misc.nix"], [])));
        obj["fetchers"] = nixScope["callLibs"]((new Path(["./fetchers.nix"], [])));
        obj["path"] = nixScope["callLibs"]((new Path(["./path"], [])));
        obj["filesystem"] = nixScope["callLibs"]((new Path(["./filesystem.nix"], [])));
        ...
        obj["isInOldestRelease"] = nixScope["self"]["trivial"]["isInOldestRelease"];
        obj["oldestSupportedReleaseIsAtLeast"] = nixScope["self"]["trivial"]["oldestSupportedReleaseIsAtLeast"];
        obj["mod"] = nixScope["self"]["trivial"]["mod"];
        obj["compare"] = nixScope["self"]["trivial"]["compare"];
        obj["splitByAndCompare"] = nixScope["self"]["trivial"]["splitByAndCompare"];
        ...
        obj["mirrorFunctionArgs"] = nixScope["self"]["trivial"]["mirrorFunctionArgs"];
        ...
        obj["composeExtensions"] = nixScope["self"]["fixedPoints"]["composeExtensions"];
        obj["composeManyExtensions"] = nixScope["self"]["fixedPoints"]["composeManyExtensions"];
        obj["makeExtensible"] = nixScope["self"]["fixedPoints"]["makeExtensible"];
        obj["makeExtensibleWithCustomName"] = nixScope["self"]["fixedPoints"]["makeExtensibleWithCustomName"];
        ...
        obj["filterAttrsRecursive"] = nixScope["self"]["attrsets"]["filterAttrsRecursive"];
        ...
        obj["mapAttrsRecursive"] = nixScope["self"]["attrsets"]["mapAttrsRecursive"];
        obj["mapAttrsRecursiveCond"] = nixScope["self"]["attrsets"]["mapAttrsRecursiveCond"];
        ...
        obj["zipAttrsWithNames"] = nixScope["self"]["attrsets"]["zipAttrsWithNames"];
        obj["zipAttrsWith"] = nixScope["self"]["attrsets"]["zipAttrsWith"];
        obj["zipAttrs"] = nixScope["self"]["attrsets"]["zipAttrs"];
        obj["recursiveUpdateUntil"] = nixScope["self"]["attrsets"]["recursiveUpdateUntil"];
        ...
        obj["dontRecurseIntoAttrs"] = nixScope["self"]["attrsets"]["dontRecurseIntoAttrs"];
        obj["cartesianProduct"] = nixScope["self"]["attrsets"]["cartesianProduct"];
        obj["cartesianProductOfSets"] = nixScope["self"]["attrsets"]["cartesianProductOfSets"];
        obj["mapCartesianProduct"] = nixScope["self"]["attrsets"]["mapCartesianProduct"];
        obj["updateManyAttrsByPath"] = nixScope["self"]["attrsets"]["updateManyAttrsByPath"];
        ...
        obj["concatImapStrings"] = nixScope["self"]["strings"]["concatImapStrings"];
        ...
        obj["concatMapStringsSep"] = nixScope["self"]["strings"]["concatMapStringsSep"];
        obj["concatMapAttrsStringSep"] = nixScope["self"]["strings"]["concatMapAttrsStringSep"];
        obj["concatImapStringsSep"] = nixScope["self"]["strings"]["concatImapStringsSep"];
        obj["concatLines"] = nixScope["self"]["strings"]["concatLines"];
        obj["makeSearchPath"] = nixScope["self"]["strings"]["makeSearchPath"];
        obj["makeSearchPathOutput"] = nixScope["self"]["strings"]["makeSearchPathOutput"];
        ...
        obj["stringToCharacters"] = nixScope["self"]["strings"]["stringToCharacters"];
        ...
        obj["readPathsFromFile"] = nixScope["self"]["strings"]["readPathsFromFile"];
        obj["fileContents"] = nixScope["self"]["strings"]["fileContents"];
        obj["textClosureList"] = nixScope["self"]["stringsWithDeps"]["textClosureList"];
        obj["textClosureMap"] = nixScope["self"]["stringsWithDeps"]["textClosureMap"];
        ...
        obj["overrideDerivation"] = nixScope["self"]["customisation"]["overrideDerivation"];
        obj["makeOverridable"] = nixScope["self"]["customisation"]["makeOverridable"];
        obj["callPackageWith"] = nixScope["self"]["customisation"]["callPackageWith"];
        obj["callPackagesWith"] = nixScope["self"]["customisation"]["callPackagesWith"];
        obj["extendDerivation"] = nixScope["self"]["customisation"]["extendDerivation"];
        obj["hydraJob"] = nixScope["self"]["customisation"]["hydraJob"];
        obj["makeScope"] = nixScope["self"]["customisation"]["makeScope"];
        obj["makeScopeWithSplicing"] = nixScope["self"]["customisation"]["makeScopeWithSplicing"];
        obj["makeScopeWithSplicing'"] = nixScope["self"]["customisation"]["makeScopeWithSplicing'"];
        obj["extendMkDerivation"] = nixScope["self"]["customisation"]["extendMkDerivation"];
        obj["lazyDerivation"] = nixScope["self"]["derivations"]["lazyDerivation"];
        obj["optionalDrvAttr"] = nixScope["self"]["derivations"]["optionalDrvAttr"];
        obj["warnOnInstantiate"] = nixScope["self"]["derivations"]["warnOnInstantiate"];
        ...
        obj["mapDerivationAttrset"] = nixScope["self"]["meta"]["mapDerivationAttrset"];
        ...
        obj["getLicenseFromSpdxId"] = nixScope["self"]["meta"]["getLicenseFromSpdxId"];
        obj["getLicenseFromSpdxIdOr"] = nixScope["self"]["meta"]["getLicenseFromSpdxIdOr"];
        ...
        obj["pathIsRegularFile"] = nixScope["self"]["filesystem"]["pathIsRegularFile"];
        obj["packagesFromDirectoryRecursive"] = nixScope["self"]["filesystem"]["packagesFromDirectoryRecursive"];
        obj["cleanSourceFilter"] = nixScope["self"]["sources"]["cleanSourceFilter"];
        obj["cleanSource"] = nixScope["self"]["sources"]["cleanSource"];
        obj["sourceByRegex"] = nixScope["self"]["sources"]["sourceByRegex"];
        obj["sourceFilesBySuffices"] = nixScope["self"]["sources"]["sourceFilesBySuffices"];
        obj["commitIdFromGitRepo"] = nixScope["self"]["sources"]["commitIdFromGitRepo"];
        ...
        obj["setDefaultModuleLocation"] = nixScope["self"]["modules"]["setDefaultModuleLocation"];
        obj["unifyModuleSyntax"] = nixScope["self"]["modules"]["unifyModuleSyntax"];
        obj["applyModuleArgsIfFunction"] = nixScope["self"]["modules"]["applyModuleArgsIfFunction"];
        ...
        obj["pushDownProperties"] = nixScope["self"]["modules"]["pushDownProperties"];
        obj["dischargeProperties"] = nixScope["self"]["modules"]["dischargeProperties"];
        ...
        obj["mkImageMediaOverride"] = nixScope["self"]["modules"]["mkImageMediaOverride"];
        ...
        obj["mkAliasDefinitions"] = nixScope["self"]["modules"]["mkAliasDefinitions"];
        obj["mkAliasAndWrapDefinitions"] = nixScope["self"]["modules"]["mkAliasAndWrapDefinitions"];
        obj["fixMergeModules"] = nixScope["self"]["modules"]["fixMergeModules"];
        obj["mkRemovedOptionModule"] = nixScope["self"]["modules"]["mkRemovedOptionModule"];
        obj["mkRenamedOptionModule"] = nixScope["self"]["modules"]["mkRenamedOptionModule"];
        obj["mkRenamedOptionModuleWith"] = nixScope["self"]["modules"]["mkRenamedOptionModuleWith"];
        obj["mkMergedOptionModule"] = nixScope["self"]["modules"]["mkMergedOptionModule"];
        obj["mkChangedOptionModule"] = nixScope["self"]["modules"]["mkChangedOptionModule"];
        obj["mkAliasOptionModule"] = nixScope["self"]["modules"]["mkAliasOptionModule"];
        obj["mkDerivedConfig"] = nixScope["self"]["modules"]["mkDerivedConfig"];
        obj["doRename"] = nixScope["self"]["modules"]["doRename"];
        obj["mkAliasOptionModuleMD"] = nixScope["self"]["modules"]["mkAliasOptionModuleMD"];
        obj["evalOptionValue"] = nixScope["lib"]["warn"]("External use of `lib.evalOptionValue` is deprecated. If your use case isn't covered by non-deprecated functions, we'd like to know more and perhaps support your use case well, instead of providing access to these low level functions. In this case please open an issue in https://github.com/nixos/nixpkgs/issues/.")(nixScope["self"]["modules"]["evalOptionValue"]);
        obj["isOption"] = nixScope["self"]["options"]["isOption"];
        obj["mkEnableOption"] = nixScope["self"]["options"]["mkEnableOption"];
        obj["mkSinkUndeclaredOptions"] = nixScope["self"]["options"]["mkSinkUndeclaredOptions"];
        obj["mergeDefaultOption"] = nixScope["self"]["options"]["mergeDefaultOption"];
        obj["mergeOneOption"] = nixScope["self"]["options"]["mergeOneOption"];
        obj["mergeEqualOption"] = nixScope["self"]["options"]["mergeEqualOption"];
        obj["mergeUniqueOption"] = nixScope["self"]["options"]["mergeUniqueOption"];
        obj["getValues"] = nixScope["self"]["options"]["getValues"];
        obj["getFiles"] = nixScope["self"]["options"]["getFiles"];
        obj["optionAttrSetToDocList"] = nixScope["self"]["options"]["optionAttrSetToDocList"];
        obj["optionAttrSetToDocList'"] = nixScope["self"]["options"]["optionAttrSetToDocList'"];
        obj["scrubOptionValue"] = nixScope["self"]["options"]["scrubOptionValue"];
        obj["literalExpression"] = nixScope["self"]["options"]["literalExpression"];
        obj["literalExample"] = nixScope["self"]["options"]["literalExample"];
        obj["showOption"] = nixScope["self"]["options"]["showOption"];
        obj["showOptionWithDefLocs"] = nixScope["self"]["options"]["showOptionWithDefLocs"];
        ...
        obj["mkPackageOptionMD"] = nixScope["self"]["options"]["mkPackageOptionMD"];
        ...
        obj["innerClosePropagation"] = nixScope["self"]["misc"]["innerClosePropagation"];
        ...
        obj["mergeAttrsConcatenateValues"] = nixScope["self"]["misc"]["mergeAttrsConcatenateValues"];
        obj["mergeAttrsNoOverride"] = nixScope["self"]["misc"]["mergeAttrsNoOverride"];
        obj["mergeAttrByFunc"] = nixScope["self"]["misc"]["mergeAttrByFunc"];
        obj["mergeAttrsByFuncDefaults"] = nixScope["self"]["misc"]["mergeAttrsByFuncDefaults"];
        obj["mergeAttrsByFuncDefaultsClean"] = nixScope["self"]["misc"]["mergeAttrsByFuncDefaultsClean"];
