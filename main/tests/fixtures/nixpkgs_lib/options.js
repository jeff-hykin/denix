...
*/(function(arg){
  ...
  `;}});
    ...
    try {
        ...
        Object.defineProperty(nixScope, "mkOption", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "default": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"defaultText": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"example": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"description": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"relatedPackages": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"type": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"apply": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"internal": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"visible": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"readOnly": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
                        "attrs": arg,
                    ...
                    runtime.scopeStack.push(nixScope)
                    try {
                        return operators.merge(nixScope["attrs"], ({"_type": "option"}))
                    } finally {
        ...
        Object.defineProperty(nixScope, "mkPackageOption", {enumerable: true, get(){return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["pkgs"] = arg; runtime.scopeStack.push(nixScope); try { return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["name"] = arg; runtime.scopeStack.push(nixScope); try { return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "nullable": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return false; })(),"default": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return nixScope["name"]; })(),"example": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"extraDescription": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return ""; })(),"pkgsText": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return "pkgs"; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
