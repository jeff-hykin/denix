    ...
    defGetter(nixScope, "cases", (nixScope) =>
      nixScope.lib["runTests"]({
        ...
        "testSubpathJoinExample6": {
          "expr":
            (nixScope.builtins["tryEval"](nixScope.subpath["join"](["/foo"])))[
              "success"
            ],
          "expected": false,
        },
        ...
        "testSubpathNormaliseWrongType": {
          "expr":
            (nixScope.builtins["tryEval"](nixScope.subpath["normalise"](null)))[
              "success"
            ],
          "expected": false,
        },
