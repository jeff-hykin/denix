...
createFunc({}, null, {}, (nixScope) => (
  /*let*/ createScope((nixScope) => {
    ...
    defGetter(
      ...
      "storeDirPath",
      (nixScope) =>
        operators.add(new Path(["/."], []), nixScope.builtins["storeDir"]),
    );
    defGetter(nixScope, "cases", (nixScope) =>
      nixScope.lib["runTests"]({
        "testAppendExample1":
          ({
        ...
        "testAppendExample4":
          ({
            "expr":
              (nixScope.builtins["tryEval"](nixScope.append("/foo")("bar")))[
                "success"
              ],
            "expected": false,
          }),
          ...
          ({
            "expr":
              (nixScope.builtins["tryEval"](
                nixScope.append(new Path(["/foo"], []))(new Path(["/bar"], [])),
              ))["success"],
            "expected": false,
          }),
        "testAppendExample6":
        ...
        "testSplitRootExample3":
          ({
            "expr": nixScope.splitRoot(new Path(["/foo/../bar"], [])),
            "expected":
              ({ "root": (new Path(["/."], [])), "subpath": "./bar" }),
          }),
        "testSplitRootExample4":
          ({
            "expr":
              (nixScope.builtins["tryEval"](nixScope.splitRoot("/foo/bar")))[
                "success"
              ],
            "expected": false,
          }),
        ...
        "testHasStorePathPrefixExample4":
          ({
            "expr": nixScope.hasStorePathPrefix(new Path(["/home/user"], [])),
            "expected": false,
          }),
        ...
        "testSubpathIsValidExample1":
          ({ "expr": nixScope.subpath["isValid"](null), "expected": false }),
        "testSubpathIsValidExample2":
          ({ "expr": nixScope.subpath["isValid"](""), "expected": false }),
        "testSubpathIsValidExample3":
          ({ "expr": nixScope.subpath["isValid"]("/foo"), "expected": false }),
        ...
        "testSubpathIsValidTwoDotsPrefix":
          ({ "expr": nixScope.subpath["isValid"]("..foo"), "expected": true }),
        ...
        "testSubpathIsValidThreeDots":
          ({ "expr": nixScope.subpath["isValid"]("..."), "expected": true }),
        ...
        "testSubpathJoinExample3":
          ({ "expr": nixScope.subpath["join"]([]), "expected": "./." }),
        ...
        "testSubpathJoinExample5":
          ({
            "expr":
              (nixScope.builtins["tryEval"](nixScope.subpath["join"]([""])))[
                "success"
              ],
            "expected": false,
          }),
        ...
        "testSubpathNormaliseExample6":
          ({ "expr": nixScope.subpath["normalise"]("."), "expected": "./." }),
        ...
        "testSubpathNormaliseExample8":
          ({
            "expr":
              (nixScope.builtins["tryEval"](nixScope.subpath["normalise"]("")))[
                "success"
              ],
            "expected": false,
          }),
        ...
        "testSubpathNormaliseIsValidDots":
          ({
            "expr": nixScope.subpath["normalise"]("./foo/.bar/.../baz...qux"),
        ...
        "testSubpathComponentsExample1":
          ({ "expr": nixScope.subpath["components"]("."), "expected": [] }),
    ...
    return (operators.ifThenElse(
      ...
      () => (nixScope.throw(
        new InterpolatedString(["Path unit tests failed: ", ""], [
          () => (nixScope.lib["generators"]["toPretty"]({})(nixScope.cases)),
        ]),
      )),
    ));
  })
