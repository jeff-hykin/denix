...
createFunc({}, null, {}, (nixScope)=>(
        ...
        try {
            ...
            Object.defineProperty(nixScope, "cabal-subdirs", {enumerable: true, get(){return nixScope["builtins"]["filter"]((
    ...
    //}
    createFunc({}, null, {}, (nixScope)=>(
                    nixScope["builtins"]["pathExists"]((operators.add(nixScope["value"], (new InterpolatedString(["/", ".cabal"], [()=>(nixScope["name"])])))))
        ...
        try {
            ...
            Object.defineProperty(nixScope, "processDir", {enumerable: true, get(){return 
    ...
    //    ,
    //}@args
    createFunc({"newScope": (nixScope)=>(nixScope["throw"]("lib.packagesFromDirectoryRecursive: newScope wasn't passed in args")),}, "args", {}, (nixScope)=>(
                    (function(){
            const nixScope = {...runtime.scopeStack.slice(-1)[0]};
            runtime.scopeStack.push(nixScope);
            try {
