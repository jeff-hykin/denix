...
export default (function(arg){
    ...
    return obj;
        ...
        Object.defineProperty(nixScope, "doCollect", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
    ...
    try {
        ...
        Object.defineProperty(nixScope, "disabledKeys", {enumerable: true, get(){return nixScope["concatMap"](((function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                    ...
                    runtime.scopeStack.push(nixScope)
                    try {
                        return nixScope["map"]((nixScope["moduleKey"](nixScope["file"])))(nixScope["disabled"])
                    } finally {
                        runtime.scopeStack.pop()
                    }
    ...
    try {
        ...
        Object.defineProperty(nixScope, "filterModules", {enumerable: true, get(){return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["modulesPath"] = arg; runtime.scopeStack.push(nixScope); try { return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
    ...
    try {
        ...
        Object.defineProperty(nixScope, "toGraph", {enumerable: true, get(){return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["modulesPath"] = arg; runtime.scopeStack.push(nixScope); try { return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
    ...
    runtime.scopeStack.push(nixScope);
    try {
        Object.defineProperty(nixScope, "defsByAttr", {enumerable: true, get(){return nixScope["zipAttrs"]((nixScope["concatLists"]((nixScope["concatMap"](((function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
    ...
    return obj;
        ...
        Object.defineProperty(nixScope, "mkRenamedOptionModuleWith", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
    ...
    try {
        ...
        Object.defineProperty(nixScope, "doRename", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "withPriority": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return true; })(),"condition": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return true; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
    ...
    try {
        ...
        return ({"not_a_module": (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "expectedClass": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
