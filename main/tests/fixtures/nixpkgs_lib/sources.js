...
createFunc({}, null, {}, (nixScope)=>(
        ...
        try {
            ...
            Object.defineProperty(nixScope, "cleanSourceWith", {enumerable: true, get(){return 
    ...
    //    ,
    //}
    createFunc({"filter": (nixScope)=>((function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["_path"] = arg; runtime.scopeStack.push(nixScope); try { return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["_type"] = arg; runtime.scopeStack.push(nixScope); try { return true; } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1]); } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1])),"name": (nixScope)=>(null),}, null, {}, (nixScope)=>(
                    (function(){
            const nixScope = {...runtime.scopeStack.slice(-1)[0]};
            runtime.scopeStack.push(nixScope);
            try {
        ...
        try {
            ...
            Object.defineProperty(nixScope, "fromSourceAttributes", {enumerable: true, get(){return 
    ...
    //}
    createFunc({}, null, {}, (nixScope)=>(
                    ({"_isLibCleanSourceWith": true, "origSrc": nixScope["origSrc"], "filter": nixScope["filter"], "name": nixScope["name"], "outPath": nixScope["builtins"]["path"](({"filter": nixScope["filter"], "name": nixScope["name"], "path": nixScope["origSrc"]}))})
                ));}});
