...
createFunc({}, null, {}, (nixScope)=>(
        ...
        runtime.scopeStack.push(nixScope);
        try {
            Object.defineProperty(nixScope, "validConstructors", {enumerable: true, get(){return nixScope["builtins"]["filter"]((
    ...
    //}
    createFunc({}, null, {}, (nixScope)=>(
                    operators.and((operators.or(operators.equal(nixScope["min"], null), operators.lessThanOrEqual(nixScope["min"], nixScope["v"]))), (operators.or(operators.equal(nixScope["max"], null), operators.lessThanOrEqual(nixScope["v"], nixScope["max"]))))
                ))))(nixScope["intConstructors"]);}});
            return nixScope["throw"]((new InterpolatedString(["\n        The GVariant type for number “", "” is unclear.\n        Please wrap the value with one of the following, depending on the value type in GSettings schema:\n\n        ", "\n      "], [()=>(nixScope["builtins"]["toString"](nixScope["v"])), ()=>(nixScope["lib"]["concatMapStringsSep"]("")((
    ...
    //}
    createFunc({}, null, {}, (nixScope)=>(
                    (new InterpolatedString(["- `lib.gvariant.", "` for `", "`"], [()=>(nixScope["name"]), ()=>(nixScope["type"])]))
