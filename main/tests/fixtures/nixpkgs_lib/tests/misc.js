...
*//*let*/ createScope(nixScope=>{
    ...
    return ({"expr": nixScope.functionArgs(nixScope["f'"]["nested"]["override"]), "expected": nixScope.functionArgs(nixScope.f)});
            ...
            )))]), "expected": 8n}), "testPipeEmpty": ({"expr": nixScope.pipe(2n)([]), "expected": 2n}), "testPipeStrings": ({"expr": nixScope.pipe([3n,4n])([(nixScope.map(nixScope.toString)),(nixScope.map((createFunc(/*arg:*/ "s", null, {}, (nixScope)=>(
                operators.add(nixScope.s, "")
            ))))),nixScope.concatStrings]), "expected": `
      3
      4
    ...
    return nixScope.composed["foo"];
            ...
            ))})), "expected": ({"a": false, "b": false})}), "testFunctionArgsSetFunctionArgs": ({"expr": nixScope.functionArgs((nixScope.setFunctionArgs((createFunc(/*arg:*/ "args", null, {}, (nixScope)=>(
                nixScope.args["x"]
            ))))(({"x": false})))), "expected": ({"x": false})}), "testConcatMapStrings": ({"expr": nixScope.concatMapStrings((createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                operators.add(nixScope.x, ";")
            ))))(["a","b","c"]), "expected": "a;b;c;"}), "testConcatStringsSep": ({"expr": nixScope.concatStringsSep(",")(["a","b","c"]), "expected": "a,b,c"}), "testConcatMapAttrsStringSepExamples": ({"expr": nixScope.concatMapAttrsStringSep("")((createFunc(/*arg:*/ "name", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "value", null, {}, (nixScope)=>(
                    (new InterpolatedString(["", ": foo-", ""], [()=>(nixScope.name), ()=>(nixScope.value)]))
                ))
    ...
    return ({"leading": nixScope.testValues((nixScope.strings["trimWith"](({"start": true})))), "trailing": nixScope.testValues((nixScope.strings["trimWith"](({"end": true})))), "both": nixScope.testValues(nixScope.strings["trim"])});
                ...
                createFunc(/*arg:*/ "curr", null, {}, (nixScope)=>(
                    nixScope.builtins["elem"](nixScope.curr)([".","-"])
                ))
            ))))(false)("foo.bar-baz"), "expected": ["foo","bar","baz"]}), "testSplitStringByLeadingDelimiter": ({"expr": nixScope.strings["splitStringBy"]((createFunc(/*arg:*/ "prev", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "curr", null, {}, (nixScope)=>(
                    nixScope.builtins["elem"](nixScope.curr)(["."])
                ))
            ))))(false)(".foo.bar.baz"), "expected": ["","foo","bar","baz"]}), "testSplitStringByTrailingDelimiter": ({"expr": nixScope.strings["splitStringBy"]((createFunc(/*arg:*/ "prev", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "curr", null, {}, (nixScope)=>(
                    nixScope.builtins["elem"](nixScope.curr)(["."])
                ))
            ))))(false)("foo.bar.baz."), "expected": ["foo","bar","baz",""]}), "testSplitStringByMultipleConsecutiveDelimiters": ({"expr": nixScope.strings["splitStringBy"]((createFunc(/*arg:*/ "prev", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "curr", null, {}, (nixScope)=>(
                    nixScope.builtins["elem"](nixScope.curr)(["."])
                ))
            ))))(false)("foo...bar"), "expected": ["foo","","","bar"]}), "testSplitStringByKeepingSplitChar": ({"expr": nixScope.strings["splitStringBy"]((createFunc(/*arg:*/ "prev", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "curr", null, {}, (nixScope)=>(
                    nixScope.builtins["elem"](nixScope.curr)(["."])
                ))
            ))))(true)("foo.bar.baz"), "expected": ["foo",".bar",".baz"]}), "testSplitStringByCaseTransition": ({"expr": nixScope.strings["splitStringBy"]((createFunc(/*arg:*/ "prev", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "curr", null, {}, (nixScope)=>(
                    operators.and(operators.notEqual(nixScope.builtins["match"]("[a-z]")(nixScope.prev), null), operators.notEqual(nixScope.builtins["match"]("[A-Z]")(nixScope.curr), null))
                ))
            ))))(true)("fooBarBaz"), "expected": ["foo","Bar","Baz"]}), "testSplitStringByEmptyString": ({"expr": nixScope.strings["splitStringBy"]((createFunc(/*arg:*/ "prev", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "curr", null, {}, (nixScope)=>(
                    nixScope.builtins["elem"](nixScope.curr)(["."])
                ))
            ))))(false)(""), "expected": [""]}), "testSplitStringByComplexPredicate": ({"expr": nixScope.strings["splitStringBy"]((createFunc(/*arg:*/ "prev", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "curr", null, {}, (nixScope)=>(
                    operators.and(operators.and(operators.and(operators.notEqual(nixScope.prev, ""), operators.notEqual(nixScope.curr, "")), operators.notEqual(nixScope.builtins["match"]("[0-9]")(nixScope.prev), null)), operators.notEqual(nixScope.builtins["match"]("[a-z]")(nixScope.curr), null))
                ))
            ))))(true)("123abc456def"), "expected": ["123","abc456","def"]}), "testSplitStringByUpperCaseStart": ({"expr": nixScope.strings["splitStringBy"]((createFunc(/*arg:*/ "prev", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "curr", null, {}, (nixScope)=>(
                    operators.notEqual(nixScope.builtins["match"]("[A-Z]")(nixScope.curr), null)
                ))
            ))))(true)("FooBarBaz"), "expected": ["","Foo","Bar","Baz"]}), "testEscapeShellArg": ({"expr": nixScope.strings["escapeShellArg"]("esc'ape"), "expected": "'esc'"}), "testEscapeShellArgEmpty": ({"expr": nixScope.strings["escapeShellArg"](""), "expected": "''"}), "testEscapeShellArgs": ({"expr": nixScope.strings["escapeShellArgs"](["one","two three","four'five"]), "expected": "one 'two three' 'four'"}), "testEscapeShellArgsUnicode": ({"expr": nixScope.strings["escapeShellArg"]("á"), "expected": "'á'"}), "testSplitStringsDerivation": ({"expr": nixScope.take(3n)((nixScope.strings["splitString"]("/")((nixScope.derivation(({"name": "name", "builder": "builder", "system": "system"})))))), "expected": ["","nix","store"]}), "testSplitVersionSingle": ({"expr": nixScope.versions["splitVersion"]("1"), "expected": ["1"]}), "testSplitVersionDouble": ({"expr": nixScope.versions["splitVersion"]("1.2"), "expected": ["1","2"]}), "testSplitVersionTriple": ({"expr": nixScope.versions["splitVersion"]("1.2.3"), "expected": ["1","2","3"]}), "testPadVersionLess": ({"expr": nixScope.versions["pad"](3n)("1.2"), "expected": "1.2.0"}), "testPadVersionLessExtra": ({"expr": nixScope.versions["pad"](3n)("1.3-rc1"), "expected": "1.3.0-rc1"}), "testPadVersionMore": ({"expr": nixScope.versions["pad"](3n)("1.2.3.4"), "expected": "1.2.3"}), "testIsStorePath": ({"expr": /*let*/ createScope(nixScope=>{
    ...
    return ({"expr": ({"assocRight": nixScope.assoc(nixScope.foldr), "assocRightIsLeft": operators.equal(nixScope.assoc(nixScope.foldr), nixScope.assoc(nixScope.foldl)), "nonAssocRight": nixScope.nonAssoc(nixScope.foldr), "nonAssocLeft": nixScope.nonAssoc(nixScope.foldl), "nonAssocRightIsNotLeft": operators.notEqual(nixScope.nonAssoc(nixScope.foldl), nixScope.nonAssoc(nixScope.foldr)), "foldIsRight": operators.equal(nixScope.nonAssoc(nixScope.fold), nixScope.nonAssoc(nixScope.foldr))}), "expected": ({"assocRight": 5050n, "assocRightIsLeft": true, "nonAssocRight": 50n, "nonAssocLeft": (-5050n), "nonAssocRightIsNotLeft": true, "foldIsRight": true})});
                ...
                createFunc(/*arg:*/ "el", null, {}, (nixScope)=>(
                    nixScope.abort("operation not called")
                ))
            ))))(0n)([]), "expected": 0n}), "testFoldl'IntegerAdding": ({"expr": nixScope["foldl'"]((createFunc(/*arg:*/ "acc", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "el", null, {}, (nixScope)=>(
                    operators.add(nixScope.acc, nixScope.el)
                ))
            ))))(0n)([1n,2n,3n]), "expected": 6n}), "testFoldl'NonDeep": ({"expr": nixScope.take(3n)((nixScope["foldl'"]((createFunc(/*arg:*/ "acc", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "el", null, {}, (nixScope)=>(
                    operators.listConcat([nixScope.el], nixScope.acc)
                ))
            ))))([(nixScope.abort("unevaluated list entry"))])([1n,2n,3n]))), "expected": [3n,2n,1n]}), "testFoldl'StrictInitial": ({"expr": (nixScope.builtins["tryEval"]((nixScope["foldl'"]((createFunc(/*arg:*/ "acc", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "el", null, {}, (nixScope)=>(
                    nixScope.el
                ))
            ))))((nixScope.throw("hello")))([]))))["success"], "expected": false}), "testFoldl'Large": ({"expr": nixScope["foldl'"]((createFunc(/*arg:*/ "acc", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "el", null, {}, (nixScope)=>(
                    operators.add(nixScope.acc, nixScope.el)
                ))
            ))))(0n)((nixScope.range(0n)(100000n))), "expected": 5000050000n}), "testTake": nixScope.testAllTrue([(operators.equal([], (nixScope.take(0n)([1n,2n,3n])))),(operators.equal([1n], (nixScope.take(1n)([1n,2n,3n])))),(operators.equal([1n,2n], (nixScope.take(2n)([1n,2n,3n])))),(operators.equal([1n,2n,3n], (nixScope.take(3n)([1n,2n,3n])))),(operators.equal([1n,2n,3n], (nixScope.take(4n)([1n,2n,3n]))))]), "testTakeEnd": /*let*/ createScope(nixScope=>{
...
}), "testDrop": /*let*/ createScope(nixScope=>{
...
}), "testDropEnd": /*let*/ createScope(nixScope=>{
    ...
    return ({"expr": nixScope.lists["commonPrefix"](nixScope.longList)(nixScope.longList), "expected": nixScope.longList});
            ...
            ))))((nixScope.sortOn((createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                nixScope.x["ok"]
            ))))([({"ok": 1n, "f": createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                nixScope.x
            ))}),({"ok": 3n, "f": createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                operators.add(nixScope.x, 3n)
            ))}),({"ok": 2n, "f": createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                nixScope.x
            ))})]))), "expected": [1n,2n,6n]}), "testReplaceString": ({"expr": nixScope.replaceString("world")("Nix")("Hello, world!"), "expected": "Hello, Nix!"}), "testReplicate": ({"expr": nixScope.replicate(3n)("a"), "expected": ["a","a","a"]}), "testToIntShouldConvertStringToInt": ({"expr": nixScope.toInt("27"), "expected": 27n}), "testToIntShouldThrowErrorIfItCouldNotConvertToInt": ({"expr": nixScope.builtins["tryEval"]((nixScope.toInt("foo"))), "expected": ({"success": false, "value": false})}), "testHasAttrByPathTrue": ({"expr": nixScope.hasAttrByPath(["a","b"])(({"a": ({"b": "yey"})})), "expected": true}), "testHasAttrByPathFalse": ({"expr": nixScope.hasAttrByPath(["a","b"])(({"a": ({"c": "yey"})})), "expected": false}), "testHasAttrByPathNonStrict": ({"expr": nixScope.hasAttrByPath([])((nixScope.throw("do not use"))), "expected": true}), "testLongestValidPathPrefix_empty_empty": ({"expr": nixScope.attrsets["longestValidPathPrefix"]([])({}), "expected": []}), "testLongestValidPathPrefix_empty_nonStrict": ({"expr": nixScope.attrsets["longestValidPathPrefix"]([])((nixScope.throw("do not use"))), "expected": []}), "testLongestValidPathPrefix_zero": ({"expr": nixScope.attrsets["longestValidPathPrefix"](["a",(nixScope.throw("do not use"))])(({"d": null})), "expected": []}), "testLongestValidPathPrefix_zero_b": ({"expr": nixScope.attrsets["longestValidPathPrefix"](["z","z"])("remarkably harmonious"), "expected": []}), "testLongestValidPathPrefix_one": ({"expr": nixScope.attrsets["longestValidPathPrefix"](["a","b","c"])(({"a": null})), "expected": ["a"]}), "testLongestValidPathPrefix_two": ({"expr": nixScope.attrsets["longestValidPathPrefix"](["a","b","c"])(createScope(nixScope=>{
    const obj = {};
    if (obj["a"] === undefined) obj["a"] = {};
    obj["a"]["b"] = null;
    return obj;
})), "expected": ["a","b"]}), "testLongestValidPathPrefix_three": ({"expr": nixScope.attrsets["longestValidPathPrefix"](["a","b","c"])(createScope(nixScope=>{
    const obj = {};
    if (obj["a"] === undefined) obj["a"] = {};
    if (obj["a"]["b"] === undefined) obj["a"]["b"] = {};
    obj["a"]["b"]["c"] = null;
    return obj;
})), "expected": ["a","b","c"]}), "testLongestValidPathPrefix_three_extra": ({"expr": nixScope.attrsets["longestValidPathPrefix"](["a","b","c"])(createScope(nixScope=>{
    const obj = {};
    if (obj["a"] === undefined) obj["a"] = {};
    if (obj["a"]["b"] === undefined) obj["a"]["b"] = {};
    ...
    return obj;
})), "expected": ["a","b","c"]}), "testFindFirstIndexExample1": ({"expr": nixScope.lists["findFirstIndex"]((createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                operators.greaterThan(nixScope.x, 3n)
            ))))((nixScope.abort("index found, so a default must not be evaluated")))([1n,6n,4n]), "expected": 1n}), "testFindFirstIndexExample2": ({"expr": nixScope.lists["findFirstIndex"]((createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                operators.greaterThan(nixScope.x, 9n)
            ))))("a very specific default")([1n,6n,4n]), "expected": "a very specific default"}), "testFindFirstIndexEmpty": ({"expr": nixScope.lists["findFirstIndex"]((nixScope.abort("when the list is empty, the predicate is not needed")))(null)([]), "expected": null}), "testFindFirstIndexSingleMatch": ({"expr": nixScope.lists["findFirstIndex"]((createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                operators.equal(nixScope.x, 5n)
            ))))(null)([5n]), "expected": 0n}), "testFindFirstIndexSingleDefault": ({"expr": nixScope.lists["findFirstIndex"]((createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                false
            ))))(null)([(nixScope.abort("if the predicate doesn't access the value, it must not be evaluated"))]), "expected": null}), "testFindFirstIndexNone": ({"expr": nixScope.builtins["tryEval"]((nixScope.lists["findFirstIndex"]((createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                operators.equal(nixScope.x, 2n)
            ))))(null)([1n,(nixScope.throw("the last element must be evaluated when there's no match"))]))), "expected": ({"success": false, "value": false})}), "testFindFirstIndexBig": ({"expr": nixScope.lists["findFirstIndex"]((createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                operators.equal(nixScope.x, 1000000n)
            ))))(null)((nixScope.range(0n)(1000000n))), "expected": 1000000n}), "testFindFirstIndexLazy": ({"expr": nixScope.lists["findFirstIndex"]((createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                operators.equal(nixScope.x, 1n)
            ))))(null)([1n,(nixScope.abort("list elements after the match must not be evaluated"))]), "expected": 0n}), "testFindFirstExample1": ({"expr": nixScope.lists["findFirst"]((createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                operators.greaterThan(nixScope.x, 3n)
            ))))(7n)([1n,6n,4n]), "expected": 6n}), "testFindFirstExample2": ({"expr": nixScope.lists["findFirst"]((createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                operators.greaterThan(nixScope.x, 9n)
            ))))(7n)([1n,6n,4n]), "expected": 7n}), "testAllUnique_true": ({"expr": nixScope.allUnique([3n,2n,4n,1n]), "expected": true}), "testAllUnique_false": ({"expr": nixScope.allUnique([3n,2n,3n,4n]), "expected": false}), "testConcatMapAttrs": ({"expr": nixScope.concatMapAttrs((createFunc(/*arg:*/ "name", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "value", null, {}, (nixScope)=>(
                    createScope(nixScope=>{
            const obj = {};
            ...
            ))))(({"foo": "bar", "foobar": "baz"})), "expected": ({"foo": "bar", "foobar": "baz", "foobarbaz": "baz"})}), "testFilterAttrs": ({"expr": nixScope.filterAttrs((createFunc(/*arg:*/ "n", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "v", null, {}, (nixScope)=>(
                    operators.and(operators.notEqual(nixScope.n, "a"), operators.equal((operators.selectOrDefault(nixScope.v, ["hello"], false)), true))
                ))
            ))))(createScope(nixScope=>{
    const obj = {};
    ...
    obj["b"]["hello"] = true;
    return obj;
})}), "testFoldlAttrs": ({"expr": ({"example": nixScope.foldlAttrs((createFunc(/*arg:*/ "acc", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "name", null, {}, (nixScope)=>(
                    createFunc(/*arg:*/ "value", null, {}, (nixScope)=>(
                        ({"sum": operators.add(nixScope.acc["sum"], nixScope.value), "names": operators.listConcat(nixScope.acc["names"], [nixScope.name])})
                    ))
                ))
            ))))(({"sum": 0n, "names": []}))(({"foo": 1n, "bar": 10n})), "emptySet": nixScope.foldlAttrs((nixScope.throw("function not needed")))(123n)({}), "valuesNotNeeded": nixScope.foldlAttrs((createFunc(/*arg:*/ "acc", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "_name", null, {}, (nixScope)=>(
                    createFunc(/*arg:*/ "_v", null, {}, (nixScope)=>(
                        nixScope.acc
                    ))
                ))
            ))))(3n)(({"z": nixScope.throw("value z not needed"), "a": nixScope.throw("value a not needed")})), "trivialAcc": nixScope.foldlAttrs((createFunc(/*arg:*/ "acc", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "_name", null, {}, (nixScope)=>(
                    createFunc(/*arg:*/ "v", null, {}, (nixScope)=>(
                        operators.add(operators.multiply(nixScope.acc, 10n), nixScope.v)
                    ))
                ))
    ...
    return ({"expr": nixScope.attrsets["mergeAttrsList"](nixScope.list), "expected": nixScope["foldl'"](nixScope.mergeAttrs)({})(nixScope.list)});
                ...
                createFunc(/*arg:*/ "l", null, {}, (nixScope)=>(
                    createFunc(/*arg:*/ "r", null, {}, (nixScope)=>(
                        operators.equal(nixScope.path, ["foo"])
                    ))
                ))
            ))))(createScope(nixScope=>{
    const obj = {};
    ...
    return ({"expr": ({"isReverseToListToAttrs": operators.equal(nixScope.builtins["listToAttrs"]((nixScope.attrsToList(nixScope.exampleAttrs))), nixScope.exampleAttrs), "isReverseToAttrsToList": operators.equal(nixScope.attrsToList((nixScope.builtins["listToAttrs"](nixScope.exampleSingletonList))), nixScope.exampleSingletonList), "testDuplicatePruningBehaviour": nixScope.attrsToList((nixScope.builtins["listToAttrs"]([({"name": "a", "value": 2n}),({"name": "a", "value": 1n})])))}), "expected": ({"isReverseToAttrsToList": true, "isReverseToListToAttrs": true, "testDuplicatePruningBehaviour": [({"name": "a", "value": 2n})]})});
            ...
            ))})))), "testFix": ({"expr": nixScope.fix((createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                ({"a": (operators.ifThenElse(operators.hasAttr(nixScope.x, "a"), ()=>("a"), ()=>("b")))})
            )))), "expected": ({"a": "a"})}), "testToExtension": ({"expr": [(nixScope.fix((createFunc(/*arg:*/ "final", null, {}, (nixScope)=>(
                ({"a": 0n, "c": nixScope.final["a"]})
            ))))),(nixScope.fix((nixScope.extends((nixScope.toExtension(({"a": 1n, "b": 2n}))))((createFunc(/*arg:*/ "final", null, {}, (nixScope)=>(
                ({"a": 0n, "c": nixScope.final["a"]})
            ))))))),(nixScope.fix((nixScope.extends((nixScope.toExtension((createFunc(/*arg:*/ "prev", null, {}, (nixScope)=>(
                ({"a": 1n, "b": nixScope.prev["a"]})
            ))))))((createFunc(/*arg:*/ "final", null, {}, (nixScope)=>(
                ({"a": 0n, "c": nixScope.final["a"]})
            ))))))),(nixScope.fix((nixScope.extends((nixScope.toExtension((createFunc(/*arg:*/ "final", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "prev", null, {}, (nixScope)=>(
                    ({"a": 1n, "b": nixScope.prev["a"], "c": operators.add(nixScope.final["a"], 1n)})
                ))
            ))))))((createFunc(/*arg:*/ "final", null, {}, (nixScope)=>(
                ({"a": 0n, "c": nixScope.final["a"]})
    ...
    `}), "testToINIEmpty": ({"expr": nixScope.generators["toINI"]({})({}), "expected": ""}), "testToINIEmptySection": ({"expr": nixScope.generators["toINI"]({})(({"foo": {}, "bar": {}})), "expected": `
      ...
      [foo]
    `}), "testToINIDuplicateKeys": ({"expr": nixScope.generators["toINI"](({"listsAsDuplicateKeys": true}))(createScope(nixScope=>{
    const obj = {};
    if (obj["foo"] === undefined) obj["foo"] = {};
    obj["foo"]["bar"] = true;
    ...
    `}), "testToINIDefaultFull": ({"expr": nixScope.generators["toINI"]({})(({"section 1": ({"attribute1": 5n, "x": "Me-se JarJar Binx", "boolean": false}), "foo[]": ({"he\\h=he": "this is okay"})})), "expected": `
      ...
      boolean=false
      x=Me-se JarJar Binx
    `}), "testToINIWithGlobalSectionEmpty": ({"expr": nixScope.generators["toINIWithGlobalSection"]({})(({"globalSection": {}, "sections": {}})), "expected": `''`}), "testToINIWithGlobalSectionGlobalEmptyIsTheSameAsToINI": /*let*/ createScope(nixScope=>{
...
}), "testToYAMLSimple": /*let*/ createScope(nixScope=>{
...
}), "testToPrettyLimitThrow": /*let*/ createScope(nixScope=>{
        nixScope.a = {};
        nixScope.a["b"] = 1n;
        nixScope.a["c"] = nixScope.a;
    ...
    return obj;
        ...
        `, "multilinestring'": `
        `})}), "testToPrettyAllowPrettyValues": ({"expr": nixScope.generators["toPretty"](({"allowPrettyValues": true}))(({"__pretty": createFunc(/*arg:*/ "v", null, {}, (nixScope)=>(
                operators.add(operators.add("«", nixScope.v), "»")
            )), "val": "foo"})), "expected": "«foo»"}), "testToPlistUnescaped": ({"expr": nixScope.mapAttrs((nixScope.const((nixScope.generators["toPlist"]({})))))(({"value": createScope(nixScope=>{
    const obj = {};
    ...
    return obj;
})})), "expected": ({"value": nixScope.builtins["readFile"]((new Path(["./test-to-plist-unescaped-expected.plist"], [])))})}), "testToPlistEscaped": ({"expr": nixScope.mapAttrs((nixScope.const((nixScope.generators["toPlist"](({"escape": true}))))))(({"value": createScope(nixScope=>{
    const obj = {};
    if (obj["nested"] === undefined) obj["nested"] = {};
    ...
    return (nixScope.opt["type"]["getSubOptions"](nixScope.opt["loc"]))["bar"]["loc"];
            ...
            ))))(({"a": [1n,2n,3n]})), "expected": [2n,4n,6n]}), "testMapCartesianProductOfTwoSets": ({"expr": nixScope.mapCartesianProduct((createFunc({}, null, {}, (nixScope)=>(
                operators.add(nixScope.a, nixScope.b)
            ))))(({"a": [1n], "b": [10n,20n]})), "expected": [11n,21n]}), "testMapCartesianProcutOfTwoSetsWithOneEmpty": ({"expr": nixScope.mapCartesianProduct((createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                operators.add(nixScope.x["a"], nixScope.x["b"])
            ))))(({"a": [], "b": [10n,20n]})), "expected": []}), "testMapCartesianProductOfThreeSets": ({"expr": nixScope.mapCartesianProduct((createFunc({}, null, {}, (nixScope)=>(
                operators.add(operators.add(nixScope.a, nixScope.b), nixScope.c)
            ))))(({"a": [1n,2n,3n], "b": [10n,20n,30n], "c": [100n,200n,300n]})), "expected": [111n,211n,311n,121n,221n,321n,131n,231n,331n,112n,212n,312n,122n,222n,322n,132n,232n,332n,113n,213n,313n,123n,223n,323n,133n,233n,333n]}), "testShowAttrPathExample": ({"expr": nixScope.showAttrPath(["foo","10","bar"]), "expected": "foo."}), "testShowAttrPathEmpty": ({"expr": nixScope.showAttrPath([]), "expected": "<root attribute path>"}), "testShowAttrPathVarious": ({"expr": nixScope.showAttrPath([".","foo","2","a2-b","_bc'de"]), "expected": `".".foo."2".a2-b._bc'de`}), "testGroupBy": ({"expr": nixScope.groupBy((createFunc(/*arg:*/ "n", null, {}, (nixScope)=>(
                nixScope.toString((nixScope.mod(nixScope.n)(5n)))
            ))))((nixScope.range(0n)(16n))), "expected": ({"0": [0n,5n,10n,15n], "1": [1n,6n,11n,16n], "2": [2n,7n,12n], "3": [3n,8n,13n], "4": [4n,9n,14n]})}), "testGroupBy'": ({"expr": nixScope["groupBy'"](nixScope.builtins["add"])(0n)((createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                nixScope.boolToString((operators.greaterThan(nixScope.x, 2n)))
            ))))([5n,1n,2n,3n,4n]), "expected": ({"false": 3n, "true": 12n})}), "testUpdateManyAttrsByPathExample": ({"expr": nixScope.updateManyAttrsByPath([({"path": ["a","b"], "update": createFunc(/*arg:*/ "old", null, {}, (nixScope)=>(
                ({"d": nixScope.old["c"]})
            ))}),({"path": ["a","b","c"], "update": createFunc(/*arg:*/ "old", null, {}, (nixScope)=>(
                operators.add(nixScope.old, 1n)
            ))}),({"path": ["x","y"], "update": createFunc(/*arg:*/ "old", null, {}, (nixScope)=>(
                "xy"
            ))})])(createScope(nixScope=>{
    const obj = {};
    if (obj["a"] === undefined) obj["a"] = {};
    ...
    obj["a"]["b"]["c"] = 0n;
    return obj;
})), "expected": ({"a": ({"b": ({"d": 1n})}), "x": ({"y": "xy"})})}), "testUpdateManyAttrsByPathNone": ({"expr": nixScope.updateManyAttrsByPath([])("something"), "expected": "something"}), "testUpdateManyAttrsByPathSingleIncrement": ({"expr": nixScope.updateManyAttrsByPath([({"path": [], "update": createFunc(/*arg:*/ "old", null, {}, (nixScope)=>(
                operators.add(nixScope.old, 1n)
            ))})])(0n), "expected": 1n}), "testUpdateManyAttrsByPathMultipleIncrements": ({"expr": nixScope.updateManyAttrsByPath([({"path": [], "update": createFunc(/*arg:*/ "old", null, {}, (nixScope)=>(
                operators.add(nixScope.old, "a")
            ))}),({"path": [], "update": createFunc(/*arg:*/ "old", null, {}, (nixScope)=>(
                operators.add(nixScope.old, "b")
            ))}),({"path": [], "update": createFunc(/*arg:*/ "old", null, {}, (nixScope)=>(
                operators.add(nixScope.old, "c")
            ))})])(""), "expected": "abc"}), "testUpdateManyAttrsByPathLazy": ({"expr": nixScope.updateManyAttrsByPath([({"path": [], "update": createFunc(/*arg:*/ "old", null, {}, (nixScope)=>(
                operators.add(nixScope.old, nixScope.throw("nope"))
            ))}),({"path": [], "update": createFunc(/*arg:*/ "old", null, {}, (nixScope)=>(
                "untainted"
            ))})])((nixScope.throw("start"))), "expected": "untainted"}), "testUpdateManyAttrsByPathDeep": ({"expr": nixScope.updateManyAttrsByPath([({"path": ["a","b","c"], "update": createFunc(/*arg:*/ "old", null, {}, (nixScope)=>(
                operators.add(nixScope.old, 1n)
            ))})])(createScope(nixScope=>{
    const obj = {};
    if (obj["a"] === undefined) obj["a"] = {};
    ...
    obj["x"]["y"]["z"] = 0n;
    return obj;
})}), "testUpdateManyAttrsByPathNestedBeforehand": ({"expr": nixScope.updateManyAttrsByPath([({"path": ["a"], "update": createFunc(/*arg:*/ "old", null, {}, (nixScope)=>(
                operators.merge(nixScope.old, ({"x": nixScope.old["b"]}))
            ))}),({"path": ["a","b"], "update": createFunc(/*arg:*/ "old", null, {}, (nixScope)=>(
                operators.add(nixScope.old, 1n)
            ))})])(createScope(nixScope=>{
    const obj = {};
    if (obj["a"] === undefined) obj["a"] = {};
    ...
    return obj;
})))["foo"], "expected": "whatever is in foo"}), "testLazyDerivationIsLazyInDerivationForMeta": ({"expr": (nixScope.lazyDerivation(({"derivation": nixScope.throw("not lazy enough"), "meta": "whatever is in meta"})))["meta"], "expected": "whatever is in meta"}), "testLazyDerivationReturnsDerivationAttrs": /*let*/ createScope(nixScope=>{
...
})(nixScope.types))["description"], "expected": "signed integer or list of (boolean or string)"}), "testTypeFunctionToPropagateFunctionArgs": ({"expr": nixScope.lib["functionArgs"](((nixScope.types["functionTo"](nixScope.types["null"]))["merge"]([])([({"value": createFunc({"b": (nixScope)=>(false),}, null, {}, (nixScope)=>(
                null
            ))}),({"value": createFunc({"c": (nixScope)=>(false),}, null, {}, (nixScope)=>(
                null
    ...
    return obj;
})), "expected": "somelonghash/bin/mainProgram"}), "testGetExe'FailureFirstArg": nixScope.testingThrow((nixScope["getExe'"]("not a derivation")("executable"))), "testGetExe'FailureSecondArg": nixScope.testingThrow((nixScope["getExe'"](({"type": "derivation"}))("dir/executable"))), "testGetLicenseFromSpdxIdOrExamples": ({"expr": [(nixScope.getLicenseFromSpdxIdOr("MIT")(null)),(nixScope.getLicenseFromSpdxIdOr("mIt")(null)),(nixScope.getLicenseFromSpdxIdOr("MY LICENSE")(nixScope.lib["licenses"]["free"])),(nixScope.getLicenseFromSpdxIdOr("MY LICENSE")(null))], "expected": [nixScope.lib["licenses"]["mit"],nixScope.lib["licenses"]["mit"],nixScope.lib["licenses"]["free"],null]}), "testGetLicenseFromSpdxIdOrThrow": nixScope.testingThrow((nixScope.getLicenseFromSpdxIdOr("MY LICENSE")((nixScope.throw("No SPDX ID matches MY LICENSE"))))), "testPlatformMatch": ({"expr": nixScope.meta["platformMatch"](({"system": "x86_64-linux"}))("x86_64-linux"), "expected": true}), "testPlatformMatchAttrs": ({"expr": nixScope.meta["platformMatch"]((nixScope.systems["elaborate"]("x86_64-linux")))((nixScope.systems["elaborate"]("x86_64-linux"))["parsed"]), "expected": true}), "testPlatformMatchNoMatch": ({"expr": nixScope.meta["platformMatch"](({"system": "x86_64-darwin"}))("x86_64-linux"), "expected": false}), "testPlatformMatchMissingSystem": ({"expr": nixScope.meta["platformMatch"]({})("x86_64-linux"), "expected": false}), "testPackagesFromDirectoryRecursive": ({"expr": nixScope.packagesFromDirectoryRecursive(({"callPackage": createFunc(/*arg:*/ "path", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "overrides", null, {}, (nixScope)=>(
                    nixScope.import(nixScope.path)(nixScope.overrides)
                ))
            )), "directory": (new Path(["./packages-from-directory/plain"], []))})), "expected": ({"a": "a", "b": "b", "c": "c", "my-namespace": ({"d": "d", "e": "e", "f": "f", "my-sub-namespace": ({"g": "g", "h": "h"})})})}), "testPackagesFromDirectoryRecursiveStringDirectory": ({"expr": nixScope.packagesFromDirectoryRecursive(({"callPackage": createFunc(/*arg:*/ "path", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "overrides", null, {}, (nixScope)=>(
                    nixScope.import(nixScope.path)(nixScope.overrides)
                ))
            )), "directory": nixScope.builtins["toString"]((new Path(["./packages-from-directory/plain"], [])))})), "expected": ({"a": "a", "b": "b", "c": "c", "my-namespace": ({"d": "d", "e": "e", "f": "f", "my-sub-namespace": ({"g": "g", "h": "h"})})})}), "testPackagesFromDirectoryRecursiveTopLevelPackageNix": ({"expr": nixScope.packagesFromDirectoryRecursive(({"callPackage": createFunc(/*arg:*/ "path", null, {}, (nixScope)=>(
                createFunc(/*arg:*/ "overrides", null, {}, (nixScope)=>(
                    nixScope.import(nixScope.path)(nixScope.overrides)
                ))
