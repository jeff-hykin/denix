...
createFunc({}, null, {}, (nixScope)=>(
        ...
        obj["options"]["nest"]["foo"] = nixScope["lib"]["mkOption"](({"type": nixScope["lib"]["types"]["bool"], "default": false}));
        if (obj["options"] === undefined) obj["options"] = {};
        if (obj["options"]["nest"] === undefined) obj["options"]["nest"] = {};
        obj["options"]["nest"]["unused"] = nixScope["lib"]["mkOption"](nixScope["deathtrapArgs"]);
