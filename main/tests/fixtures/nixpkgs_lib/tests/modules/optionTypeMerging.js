  ...
  createScope((nixScope) => {
    ...
    obj["config"]["theType"] = nixScope.lib["mkMerge"]([
      nixScope.lib["types"]["submodule"](createScope((nixScope) => {
        const obj = {};
        if (obj["options"] === undefined) obj["options"] = {};
        obj["options"]["int"] = nixScope.lib["mkOption"](
          { "type": nixScope.lib["types"]["int"], "default": 10n },
        );
        return obj;
      })),
      nixScope.lib["types"]["submodule"](createScope((nixScope) => {
        const obj = {};
        if (obj["options"] === undefined) obj["options"] = {};
        obj["options"]["str"] = nixScope.lib["mkOption"](
    ...
    if (obj["config"] === undefined) obj["config"] = {};
    if (obj["config"]["theOption"] === undefined) {
      obj["config"]["theOption"] = {};
    }
