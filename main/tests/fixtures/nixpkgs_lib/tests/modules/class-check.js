export default createFunc({}, null, {}, (nixScope) => (
  {
            ...
            "type": nixScope.lib["types"]["submoduleWith"](
              {
                "class": "nixos",
                "modules": [
                  new Path(["./assert-module-class-is-nixos.nix"], []),
                ],
              },
            ),
          },
        ),
        "nixosFail": nixScope.lib["mkOption"](
          {
            "type": nixScope.lib["types"]["submoduleWith"](
              { "class": "nixos", "modules": [] },
            ),
    ...
    "config": createScope((nixScope) => {
      ...
      obj["ok"] = nixScope.lib["evalModules"](
        {
          "class": "nixos",
          "modules": [
            new Path(["./module-class-is-nixos.nix"], []),
            new Path(["./assert-module-class-is-nixos.nix"], []),
          ],
        },
      );
      obj["fail"] = nixScope.lib["evalModules"](
        {
          ...
          "modules": [
            new Path(["./module-class-is-nixos.nix"], []),
            new Path(["./module-class-is-darwin.nix"], []),
          ],
        },
      );
      obj["fail-anon"] = nixScope.lib["evalModules"]({
        "class": "nixos",
        "modules": [
          new Path(["./module-class-is-nixos.nix"], []),
          {
      ...
      if (obj["sub"] === undefined) obj["sub"] = {};
      obj["sub"]["nixosFail"] = {
        "imports": [new Path(["./module-class-is-darwin.nix"], [])],
      };
      return obj;
    }),
  }
