  ...
  /*let*/ createScope((nixScope) => {
    ...
    return ({
      ...
      "config": createScope((nixScope) => {
        ...
        if (obj["variants"]["foo"]["attrs"] === undefined) {
          obj["variants"]["foo"]["attrs"] = {};
        }
        obj["variants"]["foo"]["attrs"]["b"] = 1n;
        if (obj["variants"] === undefined) obj["variants"] = {};
        if (obj["variants"]["bar"] === undefined) obj["variants"]["bar"] = {};
        if (obj["variants"]["bar"]["attrs"] === undefined) {
          obj["variants"]["bar"]["attrs"] = {};
        }
        obj["variants"]["bar"]["attrs"]["y"] = 1n;
        if (obj["variants"] === undefined) obj["variants"] = {};
        if (obj["variants"]["foo"] === undefined) obj["variants"]["foo"] = {};
        if (obj["variants"]["foo"]["variants"] === undefined) {
          obj["variants"]["foo"]["variants"] = {};
        }
        if (obj["variants"]["foo"]["variants"]["bar"] === undefined) {
          obj["variants"]["foo"]["variants"]["bar"] = {};
        }
        if (obj["variants"]["foo"]["variants"]["bar"]["attrs"] === undefined) {
          obj["variants"]["foo"]["variants"]["bar"]["attrs"] = {};
        }
        ...
        if (obj["variants"]["foo"]["variants"]["foo"] === undefined) {
          obj["variants"]["foo"]["variants"]["foo"] = {};
        }
        if (obj["variants"]["foo"]["variants"]["foo"]["attrs"] === undefined) {
          obj["variants"]["foo"]["variants"]["foo"]["attrs"] = {};
        }
