  ...
  /*let*/ createScope((nixScope) => {
    ...
    return ({
      "options": ({
        ...
        "list": nixScope.lib["mkOption"](
          {
            "type": nixScope.types["lazyAttrsOf"](
              nixScope.types["listOf"](nixScope.types["int"]),
            ),
          },
        ),
        "nonEmptyList": nixScope.lib["mkOption"](
          {
            "type": nixScope.types["lazyAttrsOf"](
              nixScope.types["nonEmptyListOf"](nixScope.types["int"]),
            ),
          },
        ),
        "attrs": nixScope.lib["mkOption"](
          {
            "type": nixScope.types["lazyAttrsOf"](
              nixScope.types["attrsOf"](nixScope.types["int"]),
            ),
          },
        ),
        "null": nixScope.lib["mkOption"](
          {
            "type": nixScope.types["lazyAttrsOf"](
              nixScope.types["nullOr"](nixScope.types["int"]),
            ),
          },
        ),
        "submodule": nixScope.lib["mkOption"](
          {
            "type": nixScope.types["lazyAttrsOf"](
