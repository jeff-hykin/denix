  ...
  /*let*/ createScope((nixScope) => {
    ...
    return ({
      "options": ({
        "intStrings": nixScope.mkOption({
          "type": nixScope.types["attrsOf"](
            nixScope.types["attrTag"](
              {
                "left": nixScope.mkOption({ "type": nixScope.types["int"] }),
                "right": nixScope.mkOption({ "type": nixScope.types["str"] }),
              },
            ),
          ),
        }),
        "nested": nixScope.mkOption({
          "type": nixScope.types["attrTag"]({
            "left": nixScope.mkOption({ "type": nixScope.types["int"] }),
            "right": nixScope.mkOption(
              {
                "type": nixScope.types["attrTag"](
                  {
                    "left": nixScope.mkOption(
        ...
        "merged": nixScope.mkOption({
          "type": nixScope.types["attrsOf"](
            nixScope.types["attrTag"](
              {
                "yay": nixScope.mkOption({ "type": nixScope.types["int"] }),
                "extensible": nixScope.mkOption(
                  { "type": nixScope.types["enum"](["foo"]) },
                ),
              },
            ),
          ),
        }),
        "submodules": nixScope.mkOption({
          "type": nixScope.types["attrsOf"](nixScope.types["attrTag"]({
            "foo": nixScope.mkOption(
              {
      ...
      "imports": [
        ...
        createScope((nixScope) => {
          ...
          obj["options"]["merged"] = nixScope.mkOption({
            "type": nixScope.types["attrsOf"](
              nixScope.types["attrTag"](
                {
                  "nay": nixScope.mkOption({ "type": nixScope.types["bool"] }),
                  "extensible": nixScope.mkOption(
                    { "type": nixScope.types["enum"](["bar"]) },
                  ),
                },
              ),
            ),
      ...
      "config": createScope((nixScope) => {
                  ...
                  return ((_cond) => {
                    ...
                    return ((_cond) => {
                      ...
                      return ((_cond) => {
                            ...
                            return ((_cond) => {
                              ...
                              return ((_cond) => {
                                ...
                                return ((_cond) => {
                                  ...
                                  operators.equal(
                                    nixScope
                                      .config["docs"]["submodules.<name>.qux"][
                                        "readOnly"
                                      ],
                                    false,
                                  ),
                        ...
                        operators.equal(
                          nixScope
                            .config["docs"]["submodules.<name>.qux"]["type"],
                          "string",
                        ),
                      );
                    })(
                      operators.equal(
                        nixScope
                          .config["docs"]["submodules.<name>.foo.bar"]["type"],
                        "signed integer",
                      ),
                    );
                  })(
                    operators.equal(
                      nixScope.config["merged"]["extensi-bar"],
                      { "extensible": "bar" },
                    ),
                  );
                })(
                  operators.equal(
                    nixScope.config["merged"]["extensi-foo"],
                    { "extensible": "foo" },
                  ),
                );
              })(
                operators.equal(
                  nixScope.config["merged"]["positive"],
                  { "yay": 100n },
                ),
              );
            })(
              operators.equal(
                nixScope.config["merged"]["negative"],
                { "nay": false },
              ),
            );
          })(
            operators.equal(
              nixScope.config["intStrings"]["numberOne"],
              { "left": 1n },
            ),
          );
        })(
          operators.equal(
            nixScope.config["intStrings"]["hello"],
            { "right": "hello world" },
          ),
        ));
        ...
        if (obj["intStrings"] === undefined) obj["intStrings"] = {};
        obj["intStrings"]["syntaxError4"] = nixScope.lib["mkMerge"]([
          { "a": true },
          { "b": true },
        ]);
        if (obj["intStrings"] === undefined) obj["intStrings"] = {};
        obj["intStrings"]["mergeError"] = nixScope.lib["mkMerge"]([
          { "int": nixScope.throw("do not eval") },
          { "string": nixScope.throw("do not eval") },
        ]);
        if (obj["intStrings"] === undefined) obj["intStrings"] = {};
        if (obj["intStrings"]["badTagError"] === undefined) {
          obj["intStrings"]["badTagError"] = {};
        }
        obj["intStrings"]["badTagError"]["rite"] = nixScope.throw(
          "do not eval",
        );
        if (obj["intStrings"] === undefined) obj["intStrings"] = {};
        if (obj["intStrings"]["badTagTypeError"] === undefined) {
          obj["intStrings"]["badTagTypeError"] = {};
        }
        obj["intStrings"]["badTagTypeError"]["left"] = "bad";
        if (obj["intStrings"] === undefined) obj["intStrings"] = {};
        if (obj["intStrings"]["numberOne"] === undefined) {
          obj["intStrings"]["numberOne"] = {};
        }
        obj["intStrings"]["numberOne"]["left"] = 1n;
        if (obj["intStrings"] === undefined) obj["intStrings"] = {};
        if (obj["intStrings"]["hello"] === undefined) {
          obj["intStrings"]["hello"] = {};
        }
        ...
        if (obj["merged"]["negative"] === undefined) {
          obj["merged"]["negative"] = {};
        }
        obj["merged"]["negative"]["nay"] = false;
        if (obj["merged"] === undefined) obj["merged"] = {};
        if (obj["merged"]["positive"] === undefined) {
          obj["merged"]["positive"] = {};
        }
        obj["merged"]["positive"]["yay"] = 100n;
        if (obj["merged"] === undefined) obj["merged"] = {};
        if (obj["merged"]["extensi-foo"] === undefined) {
          obj["merged"]["extensi-foo"] = {};
        }
        obj["merged"]["extensi-foo"]["extensible"] = "foo";
        if (obj["merged"] === undefined) obj["merged"] = {};
        if (obj["merged"]["extensi-bar"] === undefined) {
          obj["merged"]["extensi-bar"] = {};
        }
