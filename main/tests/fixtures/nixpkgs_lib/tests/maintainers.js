...
createFunc(
  ...
  (nixScope) => (
    /*let*/ createScope((nixScope) => {
      Object.defineProperty(nixScope, "checkMaintainer", {
        enumerable: true,
        get() {
          return createFunc(/*arg:*/ "handle", null, {}, (nixScope) => (
            createFunc(/*arg:*/ "uncheckedAttrs", null, {}, (nixScope) => (
              /*let*/ createScope((nixScope) => {
                Object.defineProperty(nixScope, "prefix", {
                  enumerable: true,
                  get() {
                    return ["lib", "maintainers", nixScope.handle];
                  },
                });
                ...
                Object.defineProperty(nixScope, "checks", {
                  enumerable: true,
                  get() {
                    return operators.listConcat(
                      nixScope.lib["optional"](
                        operators.and(
                          ...
                          operators.equal(
                            nixScope.checkedAttrs["githubId"],
                            null,
                          ),
                        ),
                      )(
      ...
      Object.defineProperty(nixScope, "missingGithubIds", {
        enumerable: true,
        get() {
          return nixScope.lib["concatLists"](
      ...
      Object.defineProperty(nixScope, "success", {
        enumerable: true,
        get() {
          return nixScope.pkgs["runCommand"]("checked-maintainers-success")({})(
            "mkdir $out",
          );
        },
      });
      Object.defineProperty(nixScope, "failure", {
        enumerable: true,
        get() {
          return nixScope.pkgs["runCommand"]("checked-maintainers-failure")({
