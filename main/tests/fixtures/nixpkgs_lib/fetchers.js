...
createFunc({}, null, {}, (nixScope)=>(
        ...
        runtime.scopeStack.push(nixScope);
        try {
            Object.defineProperty(nixScope, "normalizeHash", {enumerable: true, get(){return 
    ...
    //    ,
    //}
    createFunc({"hashTypes": (nixScope)=>(["sha256"]),"required": (nixScope)=>(true),}, null, {}, (nixScope)=>(
                    (function(){
            const nixScope = {...runtime.scopeStack.slice(-1)[0]};
            runtime.scopeStack.push(nixScope);
            try {
            ...
            Object.defineProperty(nixScope, "withNormalizedHash", {enumerable: true, get(){return 
    
    // args: {
    //    hashTypes,
    //}
    createFunc({"hashTypes": (nixScope)=>(["sha256"]),}, null, {}, (nixScope)=>(
                    (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["fetcher"] = arg; runtime.scopeStack.push(nixScope); try { return (function(){
            const nixScope = {...runtime.scopeStack.slice(-1)[0]};
            runtime.scopeStack.push(nixScope);
            try {
                nixScope["intersectAttrs"] = nixScope["lib"]["attrsets"]["intersectAttrs"];
