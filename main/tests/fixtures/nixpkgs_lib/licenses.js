export default createFunc({}, null, {}, (nixScope) => (
  /*let*/ createScope((nixScope) => {
          ...
          createFunc(
            {
              ...
              "free": (nixScope) => (true),
              "deprecated": (nixScope) => (false),
              "spdxId": (nixScope) => (null),
              "url": (nixScope) => (null),
              "fullName": (nixScope) => (null),
              "redistributable": (nixScope) => (nixScope.free),
            },
            "attrs",
            {},
            (nixScope) => (
              operators.merge(
                {
                  "shortName": nixScope.shortName,
                  "free": nixScope.free,
                  "deprecated": nixScope.deprecated,
                  "redistributable": nixScope.redistributable,
                },
                operators.merge(
                  nixScope.optionalAttrs(
                    operators.hasAttr(nixScope.attrs, "spdxId"),
                  )({
                    "spdxId": nixScope.spdxId,
                    "url":
                  ...
                  operators.merge(
                    nixScope.optionalAttrs(
                      operators.hasAttr(nixScope.attrs, "url"),
                    )({ "url": nixScope.url }),
                    nixScope.optionalAttrs(
                      operators.hasAttr(nixScope.attrs, "fullName"),
                    )({ "fullName": nixScope.fullName }),
                  ),
                ),
              )
            ),
    ...
    return nixScope.lib["mapAttrs"](nixScope.mkLicense)(operators.merge({
      ...
      "afl20":
        ({ "spdxId": "AFL-2.0", "fullName": "Academic Free License v2.0" }),
      "afl21":
        ({ "spdxId": "AFL-2.1", "fullName": "Academic Free License v2.1" }),
      "afl3":
        ({ "spdxId": "AFL-3.0", "fullName": "Academic Free License v3.0" }),
      "agpl3Only":
        ({
      ...
      "aml": ({ "spdxId": "AML", "fullName": "Apple MIT License" }),
      "ampas":
        ({
          "spdxId": "AMPAS",
      ...
      "arphicpl":
        ({ "spdxId": "Arphic-1999", "fullName": "Arphic Public License" }),
      "artistic1":
        ({ "spdxId": "Artistic-1.0", "fullName": "Artistic License 1.0" }),
      "artistic1-cl8":
        ({
      ...
      "artistic2":
        ({ "spdxId": "Artistic-2.0", "fullName": "Artistic License 2.0" }),
      "asl20": ({ "spdxId": "Apache-2.0", "fullName": "Apache License 2.0" }),
      "bitstreamVera":
        ({
      ...
      "boost":
        ({ "spdxId": "BSL-1.0", "fullName": "Boost Software License 1.0" }),
      "beerware": ({ "spdxId": "Beerware", "fullName": "Beerware License" }),
      "blueOak100":
        ({
          "spdxId": "BlueOak-1.0.0",
          "fullName": "Blue Oak Model License 1.0.0",
        }),
      "bsd0": ({ "spdxId": "0BSD", "fullName": "BSD Zero Clause License" }),
      "bsd1":
        ({ "spdxId": "BSD-1-Clause", "fullName": "BSD 1-Clause License" }),
      "bsd2":
        ({
          "spdxId": "BSD-2-Clause",
      ...
      "bsd3TheodoreTso": ({ "fullName": "BSD 3 Clause Theodore Tso Variant" }),
      "bsdAxisNoDisclaimerUnmodified":
        ({
          "fullName":
            "BSD-Axis without Warranty Disclaimer with Unmodified requirement",
          "url":
      ...
      "bsdProtection":
        ({ "spdxId": "BSD-Protection", "fullName": "BSD Protection License" }),
      "bsdSourceCode":
        ({
      ...
      "caldera": ({ "spdxId": "Caldera", "fullName": "Caldera License" }),
      "capec":
        ({
      ...
      "clArtistic":
        ({ "spdxId": "ClArtistic", "fullName": "Clarified Artistic License" }),
      "cc0":
        ({
          "spdxId": "CC0-1.0",
      ...
      "cpl10":
        ({ "spdxId": "CPL-1.0", "fullName": "Common Public License 1.0" }),
      "cronyx": ({ "spdxId": "Cronyx", "fullName": "Cronyx License" }),
      "curl": ({ "spdxId": "curl", "fullName": "curl License" }),
      "doc": ({ "spdxId": "DOC", "fullName": "DOC License" }),
      "drl10":
        ({ "spdxId": "DRL-1.0", "fullName": "Detection Rule License 1.0" }),
      "dtoa": ({ "spdxId": "dtoa", "fullName": "dtoa License" }),
      "eapl":
        ({
      ...
      "efl10":
        ({ "spdxId": "EFL-1.0", "fullName": "Eiffel Forum License v1.0" }),
      "efl20":
        ({ "spdxId": "EFL-2.0", "fullName": "Eiffel Forum License v2.0" }),
      "elastic20":
        ({
          "spdxId": "Elastic-2.0",
      ...
      "epl10":
        ({ "spdxId": "EPL-1.0", "fullName": "Eclipse Public License 1.0" }),
      "epl20":
        ({ "spdxId": "EPL-2.0", "fullName": "Eclipse Public License 2.0" }),
      "epson":
        ({
          "fullName":
      ...
      "ftl": ({ "spdxId": "FTL", "fullName": "Freetype Project License" }),
      "g4sl":
        ({
      ...
      "gfsl":
        ({
          ...
          "url":
            "https://www.gust.org.pl/projects/e-foundry/licenses/GUST-FONT-SOURCE-LICENSE.txt",
        }),
      "gpl1Only":
        ({
          "spdxId": "GPL-1.0-only",
      ...
      "gpl2UBDLPlus":
        ({
          "fullName":
            "GNU General Public License v3.0 or later (with UBDL exception)",
      ...
      "giftware": ({ "spdxId": "Giftware", "fullName": "Giftware License" }),
      "hpnd":
        ({
          "spdxId": "HPND",
      ...
      "hpndDifferentDisclaimer": ({
        ...
        "url":
          "https://gitlab.freedesktop.org/xorg/proto/xorgproto/-/blob/1914233e662d23ffb3812b80fadd0bbd064ad91c/COPYING-x11proto#L69-88",
      }),
      "hpndSellVariant":
        ({
          "fullName":
      ...
      "icu": ({ "spdxId": "ICU", "fullName": "ICU" }),
      "ijg":
        ({ "spdxId": "IJG", "fullName": "Independent JPEG Group License" }),
      "imagemagick":
        ({ "fullName": "ImageMagick License", "spdxId": "ImageMagick" }),
      "imlib2": ({ "spdxId": "Imlib2", "fullName": "Imlib2 License" }),
      "info-zip": ({ "spdxId": "Info-ZIP", "fullName": "Info-ZIP License" }),
      "inria-compcert":
        ({
          "fullName":
      ...
      "inria-zelus": ({
        ...
        "url":
          "https://github.com/INRIA/zelus/raw/829f2b97cba93b0543a9ca0272269e6b8fdad356/LICENSE",
        "free": false,
      }),
      "ipa": ({ "spdxId": "IPA", "fullName": "IPA Font License" }),
      "ipl10": ({ "spdxId": "IPL-1.0", "fullName": "IBM Public License v1.0" }),
      "isc": ({ "spdxId": "ISC", "fullName": "ISC License" }),
      "databricks":
        ({
      ...
      "fair": ({ "fullName": "Fair License", "spdxId": "Fair", "free": true }),
      "fairsource09":
        ({
      ...
      "knuth": ({ "fullName": "Knuth CTAN License", "spdxId": "Knuth-CTAN" }),
      "lal12": ({ "spdxId": "LAL-1.2", "fullName": "Licence Art Libre 1.2" }),
      "lal13": ({ "spdxId": "LAL-1.3", "fullName": "Licence Art Libre 1.3" }),
      "lens":
        ({
      ...
      "libpng": ({ "spdxId": "Libpng", "fullName": "libpng License" }),
      "libpng2":
        ({
          "spdxId": "libpng-2.0",
          "fullName": "PNG Reference Library version 2",
        }),
      "libtiff": ({ "spdxId": "libtiff", "fullName": "libtiff License" }),
      "llgpl21": ({
        "fullName":
      ...
      "llvm-exception":
        ({ "spdxId": "LLVM-exception", "fullName": "LLVM Exception" }),
      "lppl1":
        ({
          "spdxId": "LPPL-1.0",
      ...
      "lpl-102":
        ({ "spdxId": "LPL-1.02", "fullName": "Lucent Public License v1.02" }),
      "miros": ({ "spdxId": "MirOS", "fullName": "MirOS License" }),
      "mit": ({ "spdxId": "MIT", "fullName": "MIT License" }),
      "mit-cmu": ({ "spdxId": "MIT-CMU", "fullName": "CMU License" }),
      "mit-feh": ({ "spdxId": "MIT-feh", "fullName": "feh License" }),
      "mit-modern":
        ({
      ...
      "mit0": ({ "spdxId": "MIT-0", "fullName": "MIT No Attribution" }),
      "mitOpenGroup":
        ({ "spdxId": "MIT-open-group", "fullName": "MIT Open Group variant" }),
      "mpl10":
        ({ "spdxId": "MPL-1.0", "fullName": "Mozilla Public License 1.0" }),
      "mpl11":
        ({ "spdxId": "MPL-1.1", "fullName": "Mozilla Public License 1.1" }),
      "mpl20":
        ({ "spdxId": "MPL-2.0", "fullName": "Mozilla Public License 2.0" }),
      "mplus": ({ "spdxId": "mplus", "fullName": "M+ Font License" }),
      "mspl": ({ "spdxId": "MS-PL", "fullName": "Microsoft Public License" }),
      "mulan-psl2":
        ({
          "spdxId": "MulanPSL-2.0",
      ...
      "nistSoftware":
        ({ "spdxId": "NIST-Software", "fullName": "NIST Software License" }),
      "nlpl": ({ "spdxId": "NLPL", "fullName": "No Limit Public License" }),
      "nposl3":
        ({
          "spdxId": "NPOSL-3.0",
      ...
      "ofl": ({ "spdxId": "OFL-1.1", "fullName": "SIL Open Font License 1.1" }),
      "oml": ({ "spdxId": "OML", "fullName": "Open Market License" }),
      "openldap":
        ({
          "spdxId": "OLDAP-2.8",
          "fullName": "Open LDAP Public License v2.8",
        }),
      "openssl": ({ "spdxId": "OpenSSL", "fullName": "OpenSSL License" }),
      "opubl":
        ({
          "spdxId": "OPUBL-1.0",
      ...
      "osl2":
        ({ "spdxId": "OSL-2.0", "fullName": "Open Software License 2.0" }),
      "osl21":
        ({ "spdxId": "OSL-2.1", "fullName": "Open Software License 2.1" }),
      "osl3":
        ({ "spdxId": "OSL-3.0", "fullName": "Open Software License 3.0" }),
      "parity70":
        ({
          "spdxId": "Parity-7.0.0",
          "fullName": "Parity Public License 7.0.0",
        }),
      "php301": ({ "spdxId": "PHP-3.01", "fullName": "PHP License v3.01" }),
      "postgresql":
        ({ "spdxId": "PostgreSQL", "fullName": "PostgreSQL License" }),
      "postman":
        ({
      ...
      "qhull": ({ "spdxId": "Qhull", "fullName": "Qhull License" }),
      "qpl": ({ "spdxId": "QPL-1.0", "fullName": "Q Public License 1.0" }),
      "qwt":
        ({
      ...
      "ruby": ({ "spdxId": "Ruby", "fullName": "Ruby License" }),
      "sendmail": ({ "spdxId": "Sendmail", "fullName": "Sendmail License" }),
      "sfl":
        ({
      ...
      "sleepycat": ({ "spdxId": "Sleepycat", "fullName": "Sleepycat License" }),
      "smail":
        ({
          "shortName": "smail",
          "fullName": "SMAIL General Public License",
          "url":
            "https://sources.debian.org/copyright/license/debianutils/4.9.1/",
        }),
      "smlnj":
        ({
          "spdxId": "SMLNJ",
      ...
      "tcltk": ({ "spdxId": "TCL", "fullName": "TCL/TK License" }),
      "tost":
        ({
      ...
      "unfree": ({ "fullName": "Unfree", "free": false }),
      ...
      "unicode-30":
        ({ "spdxId": "Unicode-3.0", "fullName": "Unicode License v3" }),
      "unicode-dfs-2015":
        ({
      ...
      "unicodeTOU":
        ({ "spdxId": "Unicode-TOU", "fullName": "Unicode Terms of Use" }),
      "unlicense": ({ "spdxId": "Unlicense", "fullName": "The Unlicense" }),
      "upl":
        ({ "spdxId": "UPL-1.0", "fullName": "Universal Permissive License" }),
      "vim": ({ "spdxId": "Vim", "fullName": "Vim License" }),
      "virtualbox-puel":
        ({
          "fullName":
      ...
      "vsl10":
        ({ "spdxId": "VSL-1.0", "fullName": "Vovida Software License v1.0" }),
      "watcom":
        ({
          "spdxId": "Watcom-1.0",
      ...
      "w3c":
        ({ "spdxId": "W3C", "fullName": "W3C Software Notice and License" }),
      "wadalab":
        ({
      ...
      "x11": ({ "spdxId": "X11", "fullName": "X11 License" }),
      "xfig": ({ "spdxId": "Xfig", "fullName": "xfig" }),
      "xinetd": ({ "spdxId": "xinetd", "fullName": "xinetd License" }),
      "xskat": ({ "spdxId": "XSkat", "fullName": "XSkat License" }),
      "zlib": ({ "spdxId": "Zlib", "fullName": "zlib License" }),
      "zpl20": ({ "spdxId": "ZPL-2.0", "fullName": "Zope Public License 2.0" }),
      "zpl21": ({ "spdxId": "ZPL-2.1", "fullName": "Zope Public License 2.1" }),
    }, {
      "apsl10":
        ({
          "spdxId": "APSL-1.0",
