...
*/ createFunc({}, null, {}, (nixScope) => (
  /*let*/ createScope((nixScope) => {
    ...
    nixScope._coerceMany =
      nixScope.import(new Path(["./internal.nix"], []))(
        { "lib": nixScope.lib },
      )["_coerceMany"];
    nixScope._toSourceFilter =
      nixScope.import(new Path(["./internal.nix"], []))(
        { "lib": nixScope.lib },
      )["_toSourceFilter"];
    nixScope._fromSourceFilter =
      nixScope.import(new Path(["./internal.nix"], []))(
        { "lib": nixScope.lib },
      )["_fromSourceFilter"];
    nixScope._toList =
    ...
    nixScope._fileFilter =
      nixScope.import(new Path(["./internal.nix"], []))(
        { "lib": nixScope.lib },
      )["_fileFilter"];
    nixScope._printFileset =
      nixScope.import(new Path(["./internal.nix"], []))(
        { "lib": nixScope.lib },
      )["_printFileset"];
    nixScope._intersection =
      nixScope.import(new Path(["./internal.nix"], []))(
        { "lib": nixScope.lib },
      )["_intersection"];
    nixScope._difference =
      nixScope.import(new Path(["./internal.nix"], []))(
        { "lib": nixScope.lib },
      )["_difference"];
    nixScope._fromFetchGit =
      nixScope.import(new Path(["./internal.nix"], []))(
        { "lib": nixScope.lib },
      )["_fromFetchGit"];
    nixScope._fetchGitSubmodulesMinver =
      nixScope.import(new Path(["./internal.nix"], []))(
        { "lib": nixScope.lib },
    ...
    return ({
      "maybeMissing": createFunc(/*arg:*/ "path", null, {}, (nixScope) => (
        operators.ifThenElse(
          operators.negate(nixScope.isPath(nixScope.path)),
          () => (operators.ifThenElse(
            nixScope.isStringLike(nixScope.path),
            () => (nixScope.throw(
        ...
        /*let*/ createScope((nixScope) => {
          ...
          return /*let*/ createScope((nixScope) => {
            ...
            return (operators.ifThenElse(
              ...
              () => (operators.ifThenElse(
                operators.hasAttr(nixScope.root, "_isLibCleanSourceWith"),
                () => (nixScope.throw(`
                ...
                () => (operators.ifThenElse(
                  nixScope.isStringLike(nixScope.root),
                  () => (nixScope.throw(
                    new InterpolatedString([
                      "\n          lib.fileset.toSource: \\`root\\` (",
                      ") is a string-like value, but it should be a path instead.\n              Paths in strings are not supported by \\`lib.fileset\\`, use \\`lib.sources\\` or derivations instead.",
                    ], [() => (nixScope.toString(nixScope.root))]),
                  )),
                  () => (nixScope.throw(
                    new InterpolatedString([
                      "lib.fileset.toSource: \\`root\\` is of type ",
                      ", but it should be a path instead.",
                    ], [() => (nixScope.typeOf(nixScope.root))]),
                  )),
                )),
              )),
              () => (operators.ifThenElse(
                operators.and(
                  ...
                  operators.notEqual(
                    nixScope.rootFilesystemRoot,
                    nixScope.filesetFilesystemRoot,
                  ),
                ),
                () => (nixScope.throw(
                  new InterpolatedString([
                    ...
                    () => (nixScope.toString(nixScope.root)),
                    () => (nixScope.toString(nixScope.rootFilesystemRoot)),
                    () => (nixScope.toString(nixScope.filesetFilesystemRoot)),
                  ]),
                )),
                () => (operators.ifThenElse(
                  operators.negate(nixScope.pathExists(nixScope.root)),
                  () => (nixScope.throw(
                    new InterpolatedString([
                      "lib.fileset.toSource: \\`root\\` (",
                  ...
                  () => (operators.ifThenElse(
                    ...
                    () => (operators.ifThenElse(
                      operators.and(
                        ...
                        operators.negate(
                          nixScope.hasPrefix(nixScope.root)(
                      ...
                      () => (nixScope.seq(nixScope.sourceFilter)(
                        nixScope.cleanSourceWith,
                      )({
                        "name": "source",
                        "src": nixScope.root,
                        "filter": nixScope.sourceFilter,
                      })),
                    )),
                  )),
                )),
      ...
      "toList": createFunc(/*arg:*/ "fileset", null, {}, (nixScope) => (
        nixScope._toList(
          nixScope._coerce("lib.fileset.toList: Argument")(nixScope.fileset),
        )
      )),
      "union": createFunc(/*arg:*/ "fileset1", null, {}, (nixScope) => (
        createFunc(/*arg:*/ "fileset2", null, {}, (nixScope) => (
          nixScope._unionMany(
            nixScope._coerceMany("lib.fileset.union")([
      ...
      "unions": createFunc(/*arg:*/ "filesets", null, {}, (nixScope) => (
        operators.ifThenElse(
          operators.negate(nixScope.isList(nixScope.filesets)),
          () => (nixScope.throw(
            new InterpolatedString([
              "lib.fileset.unions: Argument is of type ",
              ", but it should be a list instead.",
            ], [() => (nixScope.typeOf(nixScope.filesets))]),
          )),
          () => (nixScope.pipe(nixScope.filesets)([
            ...
            nixScope._coerceMany("lib.fileset.unions"),
            nixScope._unionMany,
          ])),
        )
      )),
      ...
      "fileFilter": createFunc(/*arg:*/ "predicate", null, {}, (nixScope) => (
        createFunc(/*arg:*/ "path", null, {}, (nixScope) => (
          operators.ifThenElse(
            operators.negate(nixScope.isFunction(nixScope.predicate)),
            () => (nixScope.throw(
              new InterpolatedString([
                "lib.fileset.fileFilter: First argument is of type ",
                ", but it should be a function instead.",
              ], [() => (nixScope.typeOf(nixScope.predicate))]),
            )),
            () => (operators.ifThenElse(
              operators.negate(nixScope.isPath(nixScope.path)),
              () => (operators.ifThenElse(
                operators.equal(
                  operators.selectOrDefault(nixScope.path, ["_type"], ""),
                  "fileset",
                ),
                () => (nixScope.throw(`
              ...
              () => (operators.ifThenElse(
                ...
                () => (nixScope._fileFilter(nixScope.predicate)(nixScope.path)),
              )),
            )),
          )
        ))
        ...
        /*let*/ createScope((nixScope) => {
          ...
          return (operators.ifThenElse(
            ...
            () => (operators.ifThenElse(
              ...
              () => (operators.ifThenElse(
                nixScope.isFiltered,
                () => (nixScope._fromSourceFilter(nixScope.path)(
                  nixScope.source["filter"],
                )),
                () => (nixScope._singleton(nixScope.path)),
              )),
            )),
      ...
      "gitTracked": createFunc(/*arg:*/ "path", null, {}, (nixScope) => (
        nixScope._fromFetchGit("gitTracked")("argument")(nixScope.path)({})
      )),
      "gitTrackedWith": createFunc(
        { "recurseSubmodules": (nixScope) => (false) },
        null,
        {},
        (nixScope) => (
          createFunc(/*arg:*/ "path", null, {}, (nixScope) => (
            operators.ifThenElse(
              operators.negate(nixScope.isBool(nixScope.recurseSubmodules)),
              () => (nixScope.throw(
                new InterpolatedString([
                  "lib.fileset.gitTrackedWith: Expected the attribute `recurseSubmodules` of the first argument to be a boolean, but it's a ",
                  " instead.",
                ], [() => (nixScope.typeOf(nixScope.recurseSubmodules))]),
              )),
              () => (operators.ifThenElse(
                operators.and(
                  nixScope.recurseSubmodules,
                  nixScope.versionOlder(nixScope.nixVersion)(
                    nixScope._fetchGitSubmodulesMinver,
                  ),
                ),
                () => (nixScope.throw(
                  new InterpolatedString([
                    "lib.fileset.gitTrackedWith: Setting the attribute `recurseSubmodules` to `true` is only supported for Nix version ",
                    " and after, but Nix version ",
                    " is used.",
                  ], [
                    () => (nixScope._fetchGitSubmodulesMinver),
                    () => (nixScope.nixVersion),
                ...
                () => (nixScope._fromFetchGit("gitTrackedWith")(
                  "second argument",
                )(nixScope.path)(
                  nixScope.lib["optionalAttrs"](nixScope.recurseSubmodules)(
                    { "submodules": true },
                  ),
                )),
              )),
