...
export default (function(arg){
    ...
    runtime.scopeStack.push(nixScope);
    try {
        Object.defineProperty(nixScope, "filesets", {enumerable: true, get(){return nixScope["map"](((function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                    ...
                    runtime.scopeStack.push(nixScope)
                    try {
                        return nixScope["_coerce"]((new InterpolatedString(["", ": ", ""], [()=>(nixScope["functionContext"]), ()=>(nixScope["context"])])))(nixScope["value"])
                    } finally {
                        runtime.scopeStack.pop()
                    }
                })))(nixScope["list"]);}});
