        ...
        createFunc(/*arg:*/ "prefix", null, {}, (nixScope) => (
          createFunc(/*arg:*/ "attrName", null, {}, (nixScope) => (
            createFunc(/*arg:*/ "v", null, {}, (nixScope) => (
              /*let*/ createScope((nixScope) => {
                defGetter(nixScope, "pos", (nixScope) =>
                  nixScope.builtins["unsafeGetAttrPos"](nixScope.attrName)(
                    nixScope.v,
                  ));
    ...
    return ({
      "lazyDerivation": createFunc(/*arg:*/ "args", null, {}, (nixScope) => (
        /*let*/ createScope((nixScope) => {
          defGetter(nixScope, "checked", (nixScope) =>
            nixScope.throwIfNot(
              operators.equal(
                operators.selectOrDefault(nixScope.derivation, ["type"], null),
                "derivation",
              ),
      ...
      "warnOnInstantiate": createFunc(/*arg:*/ "msg", null, {}, (nixScope) => (
        createFunc(/*arg:*/ "drv", null, {}, (nixScope) => (
          /*let*/ createScope((nixScope) => {
            defGetter(nixScope, "drvToWrap", (nixScope) =>
              nixScope.removeAttrs(nixScope.drv)([
                "meta",
                "name",
                "type",
                "outputName",
