...
export default (function(arg){
    ...
    try {
        ...
        Object.defineProperty(nixScope, "makeScopeWithSplicing'", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                    ...
                    const nixScope = {
                        ...
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "keep": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return ((function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["_self"] = arg; runtime.scopeStack.push(nixScope); try { return {}; } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1])); })(),"extra": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return ((function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["_spliced0"] = arg; runtime.scopeStack.push(nixScope); try { return {}; } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1])); })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
    ...
    try {
        ...
        return (function(arg){
                    const nixScope = {
                        ...
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "excludeDrvArgNames": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return []; })(),"inheritFunctionArgs": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return true; })(),"transformDrv": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return nixScope["id"]; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
