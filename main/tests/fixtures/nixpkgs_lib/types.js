...
(function(arg){
    ...
    try {
        ...
        Object.defineProperty(nixScope, "elemTypeFunctor", {enumerable: true, get(){return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["name"] = arg; runtime.scopeStack.push(nixScope); try { return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
    ...
    try {
        ...
        Object.defineProperty(nixScope, "makeWrappedDeprecationMessage", {enumerable: true, get(){return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["payload"] = arg; runtime.scopeStack.push(nixScope); try { return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
    ...
    return operators.notEqual(nixScope["f"]["wrapped"], null);
        ...
        Object.defineProperty(nixScope, "mkOptionType", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "description": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"descriptionClass": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"check": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return ((function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["x"] = arg; runtime.scopeStack.push(nixScope); try { return true; } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1])); })(),"merge": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return nixScope["mergeDefaultOption"]; })(),"emptyValue": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return {}; })(),"getSubOptions": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["prefix"] = arg; runtime.scopeStack.push(nixScope); try { return {}; } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1]); })(),"getSubModules": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"substSubModules": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["m"] = arg; runtime.scopeStack.push(nixScope); try { return null; } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1]); })(),"typeMerge": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return nixScope["defaultTypeMerge"](nixScope["functor"]); })(),"functor": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return nixScope["defaultFunctor"](nixScope["name"]); })(),"deprecationMessage": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"nestedTypes": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return {}; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
    ...
    try {
        ...
        Object.defineProperty(nixScope, "pathWith", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "inStore": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"absolute": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
    ...
    try {
        ...
        return (function(arg){
                    const nixScope = {
                        ...
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "lazy": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return false; })(),"placeholder": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return "name"; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
    ...
    return obj;
        ...
        runtime.scopeStack.pop();
...
})(); } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1]); } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1]), "nestedTypes": nixScope["tags"], "functor": operators.merge(nixScope["defaultFunctor"]("attrTag"), ({"type": (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                    ...
                    runtime.scopeStack.push(nixScope)
                    try {
                        return nixScope["types"]["attrTag"](nixScope["tags"])
                    } finally {
                        runtime.scopeStack.pop()
                    }
    ...
    try {
        ...
        Object.defineProperty(nixScope, "unique", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                    ...
                    runtime.scopeStack.push(nixScope)
                    try {
                        return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["type"] = arg; runtime.scopeStack.push(nixScope); try { return nixScope["mkOptionType"]((function(){
    const nixScope = Object.create(runtime.scopeStack.slice(-1)[0]);
    nixScope["nestedTypes"] = {};
    ...
    runtime.scopeStack.push(nixScope);
    try {
        Object.defineProperty(nixScope, "optionModules", {enumerable: true, get(){return nixScope["map"](((function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                    ...
                    runtime.scopeStack.push(nixScope)
                    try {
                        return ({"_file": nixScope["file"], "options": nixScope["lib"]["mkOption"](({"type": nixScope["value"]}))})
                    } finally {
                        runtime.scopeStack.pop()
                    }
                })))(nixScope["defs"]);}});
        ...
        Object.defineProperty(nixScope, "submoduleWith", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "specialArgs": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return {}; })(),"shorthandOnlyDefinesConfig": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return false; })(),"description": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),"class": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
                        "attrs": arg,
    ...
    try {
        ...
        Object.defineProperty(nixScope, "allModules", {enumerable: true, get(){return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["defs"] = arg; runtime.scopeStack.push(nixScope); try { return nixScope["map"](((function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                    ...
                    runtime.scopeStack.push(nixScope)
                    try {
                        return (operators.ifThenElse(operators.and(nixScope["isAttrs"](nixScope["value"]), nixScope["shorthandOnlyDefinesConfig"]), ()=>(({"_file": nixScope["file"], "config": nixScope["value"]})), ()=>(({"_file": nixScope["file"], "imports": [nixScope["value"]]}))))
                    } finally {
                        runtime.scopeStack.pop()
                    }
