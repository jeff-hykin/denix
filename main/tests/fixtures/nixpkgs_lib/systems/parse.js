...
createFunc({}, null, {}, (nixScope)=>(
            ...
            defGetter(nixScope, "setTypes", (nixScope) => createFunc(/*arg:*/ "type", null, {}, (nixScope)=>(
                    nixScope.mapAttrs((createFunc(/*arg:*/ "name", null, {}, (nixScope)=>(
            ...
            defGetter(nixScope, "removeAbiSuffix", (nixScope) => createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                    /*let*/ createScope(nixScope=>{
                defGetter(nixScope, "found", (nixScope) => nixScope.match("(.*)e?abi.*")(nixScope.x));
        ...
        nixScope.types = {};
        .types["openSignificantByte"] = nixScope.mkOptionType(({"name": "significant-byte", "description": "Endianness", "merge": nixScope.mergeOneOption}));
        .types["significantByte"] = nixScope.enum((nixScope.attrValues(nixScope.significantBytes)));
        .types["bitWidth"] = nixScope.enum([8n,16n,32n,64n,128n]);
        .types["openCpuType"] = nixScope.mkOptionType(({"name": "cpu-type", "description": "instruction set architecture name and information", "merge": nixScope.mergeOneOption, "check": createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                    operators.and(nixScope.types["bitWidth"]["check"](nixScope.x["bits"]), ((operators.ifThenElse(operators.lessThan(8n, nixScope.x["bits"]), ()=>(nixScope.types["significantByte"]["check"](nixScope.x["significantByte"])), ()=>(operators.negate((operators.hasAttr(nixScope.x, "significantByte"))))))))
                ))}));
        .types["cpuType"] = nixScope.enum((nixScope.attrValues(nixScope.cpuTypes)));
        .types["openVendor"] = nixScope.mkOptionType(({"name": "vendor", "description": "vendor for the platform", "merge": nixScope.mergeOneOption}));
        .types["vendor"] = nixScope.enum((nixScope.attrValues(nixScope.vendors)));
        .types["openExecFormat"] = nixScope.mkOptionType(({"name": "exec-format", "description": "executable container used by the kernel", "merge": nixScope.mergeOneOption}));
        .types["execFormat"] = nixScope.enum((nixScope.attrValues(nixScope.execFormats)));
        .types["openKernelFamily"] = nixScope.mkOptionType(({"name": "exec-format", "description": "executable container used by the kernel", "merge": nixScope.mergeOneOption}));
        .types["kernelFamily"] = nixScope.enum((nixScope.attrValues(nixScope.kernelFamilies)));
        .types["openKernel"] = nixScope.mkOptionType(({"name": "kernel", "description": "kernel name and information", "merge": nixScope.mergeOneOption, "check": createFunc(/*arg:*/ "x", null, {}, (nixScope)=>(
                    operators.and(nixScope.types["execFormat"]["check"](nixScope.x["execFormat"]), nixScope.all(nixScope.types["kernelFamily"]["check"])((nixScope.attrValues(nixScope.x["families"]))))
                ))}));
        .types["kernel"] = nixScope.enum((nixScope.attrValues(nixScope.kernels)));
        .types["openAbi"] = nixScope.mkOptionType(({"name": "abi", "description": "binary interface for compiled code and syscalls", "merge": nixScope.mergeOneOption}));
        .types["abi"] = nixScope.enum((nixScope.attrValues(nixScope.abis)));
        .types["parsedPlatform"] = nixScope.mkOptionType(({"name": "system", "description": "fully parsed representation of llvm- or nix-style platform tuple", "merge": nixScope.mergeOneOption, "check": createFunc({}, null, {}, (nixScope)=>(
                    operators.and(operators.and(operators.and(nixScope.types["cpuType"]["check"](nixScope.cpu), nixScope.types["vendor"]["check"](nixScope.vendor)), nixScope.types["kernel"]["check"](nixScope.kernel)), nixScope.types["abi"]["check"](nixScope.abi))
                ))}));
            defGetter(nixScope, "significantBytes", (nixScope) => nixScope.setTypes(nixScope.types["openSignificantByte"])(({"bigEndian": {}, "littleEndian": {}})));
            defGetter(nixScope, "cpuTypes", (nixScope) => /*let*/ createScope(nixScope=>{
        ...
        try {
            ...
            defGetter(nixScope, "vendors", (nixScope) => nixScope.setTypes(nixScope.types["openVendor"])(({"apple": {}, "pc": {}, "knuth": {}, "w64": {}, "none": {}, "unknown": {}})));
            defGetter(nixScope, "execFormats", (nixScope) => nixScope.setTypes(nixScope.types["openExecFormat"])(({"aout": {}, "elf": {}, "macho": {}, "pe": {}, "wasm": {}, "unknown": {}})));
            defGetter(nixScope, "kernelFamilies", (nixScope) => nixScope.setTypes(nixScope.types["openKernelFamily"])(({"bsd": {}, "darwin": {}})));
            defGetter(nixScope, "kernels", (nixScope) => /*let*/ createScope(nixScope=>{
        ...
        return operators.merge(nixScope.setTypes(nixScope.types["openKernel"])(({"macos": ({"execFormat": nixScope.macho, "families": ({"darwin": nixScope.darwin}), "name": "darwin"}), "ios": ({"execFormat": nixScope.macho, "families": ({"darwin": nixScope.darwin})}), "freebsd": ({"execFormat": nixScope.elf, "families": ({"bsd": nixScope.bsd}), "name": "freebsd"}), "linux": ({"execFormat": nixScope.elf, "families": {}}), "netbsd": ({"execFormat": nixScope.elf, "families": ({"bsd": nixScope.bsd})}), "none": ({"execFormat": nixScope.unknown, "families": {}}), "openbsd": ({"execFormat": nixScope.elf, "families": ({"bsd": nixScope.bsd})}), "solaris": ({"execFormat": nixScope.elf, "families": {}}), "wasi": ({"execFormat": nixScope.wasm, "families": {}}), "redox": ({"execFormat": nixScope.elf, "families": {}}), "windows": ({"execFormat": nixScope.pe, "families": {}}), "ghcjs": ({"execFormat": nixScope.unknown, "families": {}}), "genode": ({"execFormat": nixScope.elf, "families": {}}), "mmixware": ({"execFormat": nixScope.unknown, "families": {}})})), ({"darwin": nixScope.kernels["macos"], "watchos": nixScope.kernels["ios"], "tvos": nixScope.kernels["ios"], "win32": nixScope.kernels["windows"]}));
            ...
            defGetter(nixScope, "abis", (nixScope) => nixScope.setTypes(nixScope.types["openAbi"])(({"cygnus": {}, "msvc": {}, "eabi": ({"float": "soft"}), "eabihf": ({"float": "hard"}), "elf": {}, "androideabi": {}, "android": ({"assertions": [({"assertion": createFunc(/*arg:*/ "platform", null, {}, (nixScope)=>(
                    operators.negate(nixScope.platform["isAarch32"])
                )), "message": `
                The "android" ABI is not for 32-bit ARM. Use "androideabi" instead.
              `})]}), "gnueabi": ({"float": "soft"}), "gnueabihf": ({"float": "hard"}), "gnu": ({"assertions": [({"assertion": createFunc(/*arg:*/ "platform", null, {}, (nixScope)=>(
                    operators.negate(nixScope.platform["isAarch32"])
                )), "message": `
                The "gnu" ABI is ambiguous on 32-bit ARM. Use "gnueabi" or "gnueabihf" instead.
              `}),({"assertion": createFunc(/*arg:*/ "platform", null, {}, (nixScope)=>(
                    operators.negate((operators.and(nixScope.platform["isPower64"], nixScope.platform["isBigEndian"])))
                )), "message": `
            ...
            defGetter(nixScope, "isSystem", (nixScope) => nixScope.isType("system"));
            defGetter(nixScope, "mkSystem", (nixScope) => createFunc(/*arg:*/ "components", null, {}, (nixScope)=>(
                    ((_cond)=>{
            if (!_cond) {
        ...
        return null;
                    ...
                    /*let*/ createScope(nixScope=>{
                defGetter(nixScope, "getCpu", (nixScope) => createFunc(/*arg:*/ "name", null, {}, (nixScope)=>(
                        operators.selectOrDefault(nixScope.cpuTypes, [nixScope.name], (nixScope.throw((new InterpolatedString(["Unknown CPU type: ", ""], [()=>(nixScope.name)])))))
                    )));
                defGetter(nixScope, "getVendor", (nixScope) => createFunc(/*arg:*/ "name", null, {}, (nixScope)=>(
                        operators.selectOrDefault(nixScope.vendors, [nixScope.name], (nixScope.throw((new InterpolatedString(["Unknown vendor: ", ""], [()=>(nixScope.name)])))))
                    )));
                defGetter(nixScope, "getKernel", (nixScope) => createFunc(/*arg:*/ "name", null, {}, (nixScope)=>(
                        operators.selectOrDefault(nixScope.kernels, [nixScope.name], (nixScope.throw((new InterpolatedString(["Unknown kernel: ", ""], [()=>(nixScope.name)])))))
                    )));
                defGetter(nixScope, "getAbi", (nixScope) => createFunc(/*arg:*/ "name", null, {}, (nixScope)=>(
                        operators.selectOrDefault(nixScope.abis, [nixScope.name], (nixScope.throw((new InterpolatedString(["Unknown ABI: ", ""], [()=>(nixScope.name)])))))
                    )));
                defGetter(nixScope, "parsed", (nixScope) => ({"cpu": nixScope.getCpu(nixScope.args["cpu"]), "vendor": (operators.ifThenElse(operators.hasAttr(nixScope.args, "vendor"), ()=>(nixScope.getVendor(nixScope.args["vendor"])), ()=>((operators.ifThenElse(nixScope.isDarwin(nixScope.parsed), ()=>(nixScope.vendors["apple"]), ()=>((operators.ifThenElse(nixScope.isWindows(nixScope.parsed), ()=>(nixScope.vendors["pc"]), ()=>(nixScope.vendors["unknown"]))))))))), "kernel": (operators.ifThenElse(nixScope.hasPrefix("darwin")(nixScope.args["kernel"]), ()=>(nixScope.getKernel("darwin")), ()=>((operators.ifThenElse(nixScope.hasPrefix("netbsd")(nixScope.args["kernel"]), ()=>(nixScope.getKernel("netbsd")), ()=>(nixScope.getKernel((nixScope.removeAbiSuffix(nixScope.args["kernel"]))))))))), "abi": (operators.ifThenElse(operators.hasAttr(nixScope.args, "abi"), ()=>(nixScope.getAbi(nixScope.args["abi"])), ()=>((operators.ifThenElse(operators.or(nixScope.isLinux(nixScope.parsed), nixScope.isWindows(nixScope.parsed)), ()=>((operators.ifThenElse(nixScope.isAarch32(nixScope.parsed), ()=>((operators.ifThenElse(nixScope.versionAtLeast((operators.selectOrDefault(nixScope.parsed, ["cpu", "version"], "0")))("6"), ()=>(nixScope.abis["gnueabihf"]), ()=>(nixScope.abis["gnueabi"])))), ()=>((operators.ifThenElse(operators.and(nixScope.isPower64(nixScope.parsed), nixScope.isBigEndian(nixScope.parsed)), ()=>(nixScope.abis["gnuabielfv2"]), ()=>(nixScope.abis["gnu"]))))))), ()=>(nixScope.abis["unknown"]))))))}));
            return nixScope.mkSystem(nixScope.parsed);
        })
                )));
            defGetter(nixScope, "mkSystemFromString", (nixScope) => createFunc(/*arg:*/ "s", null, {}, (nixScope)=>(
                    nixScope.mkSystemFromSkeleton((nixScope.mkSkeletonFromList((nixScope.splitString("-")(nixScope.s)))))
                )));
            defGetter(nixScope, "kernelName", (nixScope) => createFunc(/*arg:*/ "kernel", null, {}, (nixScope)=>(
                    operators.add(nixScope.kernel["name"], nixScope.toString((operators.selectOrDefault(nixScope.kernel, ["version"], ""))))
                )));
            defGetter(nixScope, "darwinArch", (nixScope) => createFunc(/*arg:*/ "cpu", null, {}, (nixScope)=>(
                    (operators.ifThenElse(operators.equal(nixScope.cpu["name"], "aarch64"), ()=>("arm64"), ()=>(nixScope.cpu["name"])))
                )));
            defGetter(nixScope, "doubleFromSystem", (nixScope) => createFunc({}, null, {}, (nixScope)=>(
                    (operators.ifThenElse(operators.equal(nixScope.abi, nixScope.abis["cygnus"]), ()=>((new InterpolatedString(["", "-cygwin"], [()=>(nixScope.cpu["name"])]))), ()=>((operators.ifThenElse(operators.hasAttr(nixScope.kernel["families"], "darwin"), ()=>((new InterpolatedString(["", "-darwin"], [()=>(nixScope.cpu["name"])]))), ()=>((new InterpolatedString(["", "-", ""], [()=>(nixScope.cpu["name"]), ()=>(nixScope.kernelName(nixScope.kernel))]))))))))
                )));
            defGetter(nixScope, "tripleFromSystem", (nixScope) => createFunc({}, "sys", {}, (nixScope)=>(
                    ((_cond)=>{
            if (!_cond) {
                throw new Error("assertion failed: " + "isSystem sys");
            }
            return /*let*/ createScope(nixScope=>{
                defGetter(nixScope, "optExecFormat", (nixScope) => nixScope.optionalString((operators.and(operators.equal(nixScope.kernel["name"], "netbsd"), operators.notEqual(nixScope.gnuNetBSDDefaultExecFormat(nixScope.cpu), nixScope.kernel["execFormat"]))))(nixScope.kernel["execFormat"]["name"]));
                defGetter(nixScope, "optAbi", (nixScope) => nixScope.optionalString((operators.notEqual(nixScope.abi, nixScope.abis["unknown"])))((new InterpolatedString(["-", ""], [()=>(nixScope.abi["name"])]))));
                defGetter(nixScope, "cpuName", (nixScope) => (operators.ifThenElse(operators.hasAttr(nixScope.kernel["families"], "darwin"), ()=>(nixScope.darwinArch(nixScope.cpu)), ()=>(nixScope.cpu["name"]))));
