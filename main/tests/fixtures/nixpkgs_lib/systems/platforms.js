            ...
            () => (operators.ifThenElse(
              ...
              () => (/*let*/ createScope((nixScope) => {
                ...
                return (operators.ifThenElse(
                  ...
                  () => (nixScope.pc),
                  () => (operators.ifThenElse(
                    nixScope.lib["versionOlder"](nixScope.version)("6"),
                    () => (nixScope.sheevaplug),
                    () => (operators.ifThenElse(
                      nixScope.lib["versionOlder"](nixScope.version)("7"),
              ...
              () => (operators.ifThenElse(
                nixScope.platform["isAarch64"],
                () => (operators.ifThenElse(
                  nixScope.platform["isDarwin"],
                  () => (nixScope["apple-m1"]),
                  () => (nixScope["aarch64-multiplatform"]),
                )),
                () => (operators.ifThenElse(
                  nixScope.platform["isLoongArch64"],
                  () => (nixScope["loongarch64-multiplatform"]),
                  () => (operators.ifThenElse(
                    nixScope.platform["isRiscV"],
                    () => (nixScope["riscv-multiplatform"]),
                    () => (operators.ifThenElse(
                      operators.equal(
                        nixScope.platform["parsed"]["cpu"],
                        nixScope.lib["systems"]["parse"]["cpuTypes"]["mipsel"],
                      ),
                      ...
                      () => (operators.ifThenElse(
                        operators.equal(
                          nixScope.platform["parsed"]["cpu"],
                          nixScope
                            .lib["systems"]["parse"]["cpuTypes"]["powerpc64le"],
                        ),
                        () => (nixScope.powernv),
                        () => (operators.ifThenElse(
                          nixScope.platform["isLoongArch64"],
