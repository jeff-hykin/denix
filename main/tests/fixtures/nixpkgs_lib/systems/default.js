...
export default createFunc({}, null, {}, (nixScope) => (
  /*let*/ createScope((nixScope) => {
    ...
    Object.defineProperty(nixScope, "doubles", {
      enumerable: true,
      get() {
        return nixScope.import(new Path(["./doubles.nix"], []))(
          { "lib": nixScope.lib },
        );
      },
    });
    Object.defineProperty(nixScope, "parse", {
      enumerable: true,
      get() {
        return nixScope.import(new Path(["./parse.nix"], []))(
          { "lib": nixScope.lib },
        );
      },
    });
    Object.defineProperty(nixScope, "inspect", {
      enumerable: true,
      get() {
        return nixScope.import(new Path(["./inspect.nix"], []))(
          { "lib": nixScope.lib },
        );
      },
    });
    ...
    Object.defineProperty(nixScope, "examples", {
      enumerable: true,
      get() {
        return nixScope.import(new Path(["./examples.nix"], []))(
          { "lib": nixScope.lib },
        );
      },
    });
    Object.defineProperty(nixScope, "architectures", {
      enumerable: true,
      get() {
        return nixScope.import(new Path(["./architectures.nix"], []))(
          { "lib": nixScope.lib },
        );
      },
    });
    Object.defineProperty(nixScope, "equals", {
      enumerable: true,
      get() {
        return /*let*/ createScope((nixScope) => {
          Object.defineProperty(nixScope, "removeFunctions", {
            enumerable: true,
            get() {
    ...
    Object.defineProperty(nixScope, "flakeExposed", {
      enumerable: true,
      get() {
        return nixScope.import(new Path(["./flake-systems.nix"], []))({});
      },
    });
    Object.defineProperty(nixScope, "systemToAttrs", {
      enumerable: true,
      get() {
        return createFunc(/*arg:*/ "systemOrArgs", null, {}, (nixScope) => (
    ...
    Object.defineProperty(nixScope, "elaborate", {
      enumerable: true,
      get() {
        return createFunc(/*arg:*/ "systemOrArgs", null, {}, (nixScope) => (
          /*let*/ createScope((nixScope) => {
            Object.defineProperty(nixScope, "allArgs", {
              enumerable: true,
              get() {
                return nixScope.systemToAttrs(nixScope.systemOrArgs);
              },
            });
            Object.defineProperty(nixScope, "args", {
              enumerable: true,
              get() {
                return nixScope.builtins["removeAttrs"](nixScope.allArgs)([
                  "parsed",
                  "system",
                ]);
              },
            });
            Object.defineProperty(nixScope, "rust", {
              enumerable: true,
              get() {
            ...
            Object.defineProperty(nixScope, "final", {
              enumerable: true,
              get() {
                return operators.merge(
                  ...
                  operators.merge(
                    /*let*/ createScope((nixScope) => {
                      Object.defineProperty(nixScope, "selectEmulator", {
                        enumerable: true,
                        get() {
                          return createFunc(
                            /*arg:*/ "pkgs",
                            ...
                            (nixScope) => (
                              /*let*/ createScope((nixScope) => {
                                Object.defineProperty(nixScope, "wine", {
                                  enumerable: true,
                                  get() {
                                    return (nixScope.pkgs["winePackagesFor"](
                                      new InterpolatedString(["wine", ""], [
                                        () => (nixScope.toString(
                                          nixScope
                                            .final["parsed"]["cpu"]["bits"],
                                        )),
                                      ]),
                                    ))["minimal"];
                                  },
                                ...
                                return (operators.ifThenElse(
                                  ...
                                  () => (nixScope.lib["getExe"](
                                    nixScope.pkgs["writeShellScriptBin"](
                                      "exec",
                                    )(`exec "$@"`),
                                  )),
                                  () => (operators.ifThenElse(
                      ...
                      return ({
                        ...
                        "staticEmulatorAvailable": createFunc(
                          ...
                          (nixScope) => (
                            operators.and(
                              nixScope.final["emulatorAvailable"](
                                nixScope.pkgs,
                              ),
                              operators.or(
                                operators.or(
                          ...
                          operators.merge({
                            "rust": operators.merge(nixScope.rust, {
                              ...
                              "rustcTarget": /*let*/ createScope((nixScope) => {
                                ...
                                Object.defineProperty(nixScope, "cpu_", {
                                  enumerable: true,
                                  get() {
                                    return operators.selectOrDefault(
                                      nixScope.rust,
                                ...
                                Object.defineProperty(nixScope, "vendor_", {
                                  enumerable: true,
                                  get() {
                                    return nixScope
                                      .final["rust"]["platform"]["vendor"];
                                  },
                                });
                                return operators.selectOrDefault(
                                  nixScope.args,
                              ...
                              "rustcTargetSpec": operators.selectOrDefault(
                                ...
                                operators.ifThenElse(
                                  ...
                                  () => (nixScope.builtins["toFile"](
                                    ...
                                    nixScope.rust["platform"],
                                  ))),
                                  () => (nixScope.final["rust"]["rustcTarget"]),
                                ),
                              ),
                              "cargoShortTarget": nixScope.removeSuffix(
                                ".json",
                              )(nixScope.baseNameOf(
                                new InterpolatedString(["", ""], [
                                  () => (nixScope
