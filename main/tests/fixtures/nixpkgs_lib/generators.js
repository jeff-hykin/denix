...
*/(function(arg){
    ...
    runtime.scopeStack.push(nixScope);
    try {
        Object.defineProperty(nixScope, "mkValueStringDefault", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                    ...
                    runtime.scopeStack.push(nixScope)
                    try {
                        return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["v"] = arg; runtime.scopeStack.push(nixScope); try { return (function(){
    const nixScope = {...runtime.scopeStack.slice(-1)[0]};
    runtime.scopeStack.push(nixScope);
    try {
        ...
        Object.defineProperty(nixScope, "mkKeyValueDefault", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "mkValueString": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return nixScope["mkValueStringDefault"]({}); })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
        ...
        Object.defineProperty(nixScope, "toKeyValue", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "mkKeyValue": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return nixScope["mkKeyValueDefault"]({})("="); })(),"listsAsDuplicateKeys": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return false; })(),"indent": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return ""; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
    ...
    try {
        ...
        Object.defineProperty(nixScope, "toINI", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "mkSectionName": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return ((function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["name"] = arg; runtime.scopeStack.push(nixScope); try { return nixScope["escape"](["[","]"])(nixScope["name"]); } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1])); })(),"mkKeyValue": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return nixScope["mkKeyValueDefault"]({})("="); })(),"listsAsDuplicateKeys": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return false; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
                    ...
                    runtime.scopeStack.push(nixScope)
                    try {
                        return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["attrsOfAttrs"] = arg; runtime.scopeStack.push(nixScope); try { return (function(){
    const nixScope = {...runtime.scopeStack.slice(-1)[0]};
    runtime.scopeStack.push(nixScope);
    try {
        ...
        Object.defineProperty(nixScope, "toINIWithGlobalSection", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                    ...
                    const nixScope = {
                        ...
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "sections": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return {}; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
                    ...
                    runtime.scopeStack.push(nixScope)
                    try {
                        return operators.add(((operators.ifThenElse(operators.equal(nixScope["globalSection"], {}), ()=>(""), ()=>(operators.add((nixScope["toKeyValue"](({"mkKeyValue": nixScope["mkKeyValue"], "listsAsDuplicateKeys": nixScope["listsAsDuplicateKeys"]}))(nixScope["globalSection"])), ""))))), (nixScope["toINI"](({"mkSectionName": nixScope["mkSectionName"], "mkKeyValue": nixScope["mkKeyValue"], "listsAsDuplicateKeys": nixScope["listsAsDuplicateKeys"]}))(nixScope["sections"])))
                    } finally {
                        runtime.scopeStack.pop()
                    }
                })
    ...
    return obj;
        ...
        Object.defineProperty(nixScope, "withRecursion", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "throwOnDepthLimit": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return true; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
    ...
    try {
        ...
        Object.defineProperty(nixScope, "toPretty", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "allowPrettyValues": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return false; })(),"multiline": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return true; })(),"indent": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return ""; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
    ...
    try {
        ...
        Object.defineProperty(nixScope, "toPlist", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "escape": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return false; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
    ...
    try {
        ...
        Object.defineProperty(nixScope, "toDhall", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
    ...
    try {
        ...
        Object.defineProperty(nixScope, "toLua", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "multiline": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return true; })(),"indent": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return ""; })(),"asBindings": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return false; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
                        "args": arg,
    ...
    try {
        ...
        Object.defineProperty(nixScope, "isLuaInline", {enumerable: true, get(){return (function(arg){
                    const nixScope = {
                        // inherit parent scope
                        ...runtime.scopeStack.slice(-1)[0],
                        // inherit default arguments
                        "_type": (()=>{ const nixScope = runtime.scopeStack.slice(-1)[0]; return null; })(),
                        // inherit arguments
                        ...arg,
                        // all-args arg (if @ syntax is used)
                    ...
                    runtime.scopeStack.push(nixScope)
                    try {
                        return operators.equal(nixScope["_type"], "lua-inline")
                    } finally {
                        runtime.scopeStack.pop()
                    }
                });}});
    ...
    return nixScope["concatStrings"]((nixScope["mapAttrsToList"](((function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["key"] = arg; runtime.scopeStack.push(nixScope); try { return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["value"] = arg; runtime.scopeStack.push(nixScope); try { return (new InterpolatedString(["", "", " = ", ""], [()=>(nixScope["indent"]), ()=>(nixScope["key"]), ()=>(nixScope["toLua"](nixScope["innerArgs"])(nixScope["value"]))])); } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1]); } finally { runtime.scopeStack.pop(); } }; })(runtime.scopeStack[runtime.scopeStack.length-1])))(nixScope["v"])));
        ...
        runtime.scopeStack.pop();
                    ...
                    runtime.scopeStack.push(nixScope)
                    try {
                        return nixScope["lib"]["strings"]["toJSON"]
                    } finally {
                        runtime.scopeStack.pop()
                    }
                }), "toYAML": (function(arg){
