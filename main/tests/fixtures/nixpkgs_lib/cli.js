...
export default (function(arg){
    ...
    try {
        ...
        Object.defineProperty(nixScope, "toGNUCommandLine", {enumerable: true, get(){return (function(arg){
                    ...
                    runtime.scopeStack.push(nixScope)
                    try {
                        return (function(__capturedScope){ return (arg)=>{ const nixScope = Object.create(__capturedScope || runtime.scopeStack[runtime.scopeStack.length-1]); nixScope["options"] = arg; runtime.scopeStack.push(nixScope); try { return (function(){
