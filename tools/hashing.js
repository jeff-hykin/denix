...
// sha1
// 
    export function sha1Hex(data) { // works with strings and Uint8Arrays
        return sha1Core.createHash().update(data).digest('hex')
    }
// 
// sha512
// 
    export function sha512Hex(data) { // works with strings and Uint8Arrays
        return sha512(data)
    }
...
//
    export function sha256Hex(data) { // works with strings and Uint8Arrays
        const result = sha256Bytes(data)
