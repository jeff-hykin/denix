...
while (true) {
    ...
    await $`claude --allowedTools "Task,Edit,Read,Update,Write,WebFetch,WebSearch,Glob,Grep,Write(./**/*),Bash(*)" -p ${`
            ...
            - Remind the agent that implementations should be based on nix documentation and behavior. E.g. read while working on builtins.fetchTarball read https://noogle.dev/f/builtins/fetchTarball 
